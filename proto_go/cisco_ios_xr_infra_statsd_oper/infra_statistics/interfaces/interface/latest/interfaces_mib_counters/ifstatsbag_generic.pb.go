...
func (*IfstatsbagGeneric_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_3def900dd6f76c4b, []int{0}
}
...
func (*IfstatsbagGeneric) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_3def900dd6f76c4b, []int{1}
}
...
func init() {
	proto.RegisterFile("ifstatsbag_generic.proto", fileDescriptor_ifstatsbag_generic_3def900dd6f76c4b)
}

var fileDescriptor_ifstatsbag_generic_3def900dd6f76c4b = []byte{
