...
func (*IfstatsbagGeneric_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_963f73f5a65cbeea, []int{0}
}
...
func (*IfstatsbagGeneric) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_963f73f5a65cbeea, []int{1}
}
...
func init() {
	proto.RegisterFile("ifstatsbag_generic.proto", fileDescriptor_ifstatsbag_generic_963f73f5a65cbeea)
}

var fileDescriptor_ifstatsbag_generic_963f73f5a65cbeea = []byte{
