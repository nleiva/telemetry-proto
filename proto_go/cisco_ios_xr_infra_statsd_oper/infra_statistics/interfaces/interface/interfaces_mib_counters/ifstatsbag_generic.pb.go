...
func (*IfstatsbagGeneric_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_ad5e602a459c80df, []int{0}
}
...
func (*IfstatsbagGeneric) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_ad5e602a459c80df, []int{1}
}
...
func init() {
	proto.RegisterFile("ifstatsbag_generic.proto", fileDescriptor_ifstatsbag_generic_ad5e602a459c80df)
}

var fileDescriptor_ifstatsbag_generic_ad5e602a459c80df = []byte{
