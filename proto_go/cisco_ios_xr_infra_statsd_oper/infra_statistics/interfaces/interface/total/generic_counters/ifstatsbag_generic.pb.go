...
func (*IfstatsbagGeneric_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_2ecc053cfcd37b21, []int{0}
}
...
func (*IfstatsbagGeneric) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_2ecc053cfcd37b21, []int{1}
}
...
func init() {
	proto.RegisterFile("ifstatsbag_generic.proto", fileDescriptor_ifstatsbag_generic_2ecc053cfcd37b21)
}

var fileDescriptor_ifstatsbag_generic_2ecc053cfcd37b21 = []byte{
