...
func (*StatsdbagDatarate_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_statsdbag_datarate_1e4ee921a8d035b7, []int{0}
}
...
func (*StatsdbagDatarate) Descriptor() ([]byte, []int) {
	return fileDescriptor_statsdbag_datarate_1e4ee921a8d035b7, []int{1}
}
...
func init() {
	proto.RegisterFile("statsdbag_datarate.proto", fileDescriptor_statsdbag_datarate_1e4ee921a8d035b7)
}

var fileDescriptor_statsdbag_datarate_1e4ee921a8d035b7 = []byte{
