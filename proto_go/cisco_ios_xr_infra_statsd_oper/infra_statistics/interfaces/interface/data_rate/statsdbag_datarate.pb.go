...
func (*StatsdbagDatarate_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_statsdbag_datarate_1559f880ca956180, []int{0}
}
...
func (*StatsdbagDatarate) Descriptor() ([]byte, []int) {
	return fileDescriptor_statsdbag_datarate_1559f880ca956180, []int{1}
}
...
func init() {
	proto.RegisterFile("statsdbag_datarate.proto", fileDescriptor_statsdbag_datarate_1559f880ca956180)
}

var fileDescriptor_statsdbag_datarate_1559f880ca956180 = []byte{
