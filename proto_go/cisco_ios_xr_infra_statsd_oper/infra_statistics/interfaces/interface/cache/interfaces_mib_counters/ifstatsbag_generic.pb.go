...
func (*IfstatsbagGeneric_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_f32301703ff60ea2, []int{0}
}
...
func (*IfstatsbagGeneric) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_generic_f32301703ff60ea2, []int{1}
}
...
func init() {
	proto.RegisterFile("ifstatsbag_generic.proto", fileDescriptor_ifstatsbag_generic_f32301703ff60ea2)
}

var fileDescriptor_ifstatsbag_generic_f32301703ff60ea2 = []byte{
