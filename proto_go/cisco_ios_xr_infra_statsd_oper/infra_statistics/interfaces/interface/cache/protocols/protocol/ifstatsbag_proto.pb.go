...
func (*IfstatsbagProto_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_proto_d04b777cdae501f9, []int{0}
}
...
func (*IfstatsbagProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_ifstatsbag_proto_d04b777cdae501f9, []int{1}
}
...
func init() {
	proto.RegisterFile("ifstatsbag_proto.proto", fileDescriptor_ifstatsbag_proto_d04b777cdae501f9)
}

var fileDescriptor_ifstatsbag_proto_d04b777cdae501f9 = []byte{
