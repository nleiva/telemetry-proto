...
type OpticsEdmInfo struct {
	...
	RxPower int32 `protobuf:"zigzag32,94,opt,name=rx_power,json=rxPower,proto3" json:"rx_power,omitempty"`
	// Transmit Power in 0.01 dB
	TxPower int32 `protobuf:"zigzag32,95,opt,name=tx_power,json=txPower,proto3" json:"tx_power,omitempty"`
	...
	SafetyControlModeConfigVal    string `protobuf:"bytes,122,opt,name=safety_control_mode_config_val,json=safetyControlModeConfigVal,proto3" json:"safety_control_mode_config_val,omitempty"`
	// Total Receive Power for Multi_Lane Optics in dBm
	TotalRxPower int32 `protobuf:"zigzag32,123,opt,name=total_rx_power,json=totalRxPower,proto3" json:"total_rx_power,omitempty"`
	// Total Transmit Power for Multi_Lane Optics in dBm
	TotalTxPower int32 `protobuf:"zigzag32,124,opt,name=total_tx_power,json=totalTxPower,proto3" json:"total_tx_power,omitempty"`
	// Transceiver Vendor Details
	TransceiverInfo *OpticsTransceiverData `protobuf:"bytes,125,opt,name=transceiver_info,json=transceiverInfo,proto3" json:"transceiver_info,omitempty"`
	// Is BO configured ?
	IsBoConfigured bool `protobuf:"varint,126,opt,name=is_bo_configured,json=isBoConfigured,proto3" json:"is_bo_configured,omitempty"`
	// Are the Extended Parameters Valid ?
	IsExtParamValid bool `protobuf:"varint,127,opt,name=is_ext_param_valid,json=isExtParamValid,proto3" json:"is_ext_param_valid,omitempty"`
	// Extended optics parameters
	ExtParamVal *OpticsExtParam `protobuf:"bytes,128,opt,name=ext_param_val,json=extParamVal,proto3" json:"ext_param_val,omitempty"`
	// Extended optics parameters threshold values
	ExtParamThresholdVal *OpticsExtThresholdParam `protobuf:"bytes,129,opt,name=ext_param_threshold_val,json=extParamThresholdVal,proto3" json:"ext_param_threshold_val,omitempty"`
	// Are there any alarms ?
	AlarmDetected bool `protobuf:"varint,130,opt,name=alarm_detected,json=alarmDetected,proto3" json:"alarm_detected,omitempty"`
	// Rx Low Warning threshold value in units of 0.1dBm
	RxLowWarningThreshold int32 `protobuf:"zigzag32,131,opt,name=rx_low_warning_threshold,json=rxLowWarningThreshold,proto3" json:"rx_low_warning_threshold,omitempty"`
	// Rx High Warning threshold value in units of 0.1dBm
	RxHighWarningThreshold int32 `protobuf:"zigzag32,132,opt,name=rx_high_warning_threshold,json=rxHighWarningThreshold,proto3" json:"rx_high_warning_threshold,omitempty"`
	// Tx Low Warning threshold value in units of 0.1dBm
	TxLowWarningThreshold int32 `protobuf:"zigzag32,133,opt,name=tx_low_warning_threshold,json=txLowWarningThreshold,proto3" json:"tx_low_warning_threshold,omitempty"`
	// Tx High Warning threshold value in units of 0.1dBm
	TxHighWarningThreshold int32 `protobuf:"zigzag32,134,opt,name=tx_high_warning_threshold,json=txHighWarningThreshold,proto3" json:"tx_high_warning_threshold,omitempty"`
	// LBC high Warning threshold default value in unit of 0.001mA
	LbcThHighWarningDefault int32 `protobuf:"zigzag32,135,opt,name=lbc_th_high_warning_default,json=lbcThHighWarningDefault,proto3" json:"lbc_th_high_warning_default,omitempty"`
	// LBC low warning threshold default value in units of 0.001mA
	LbcThLowWarningDefault int32 `protobuf:"zigzag32,136,opt,name=lbc_th_low_warning_default,json=lbcThLowWarningDefault,proto3" json:"lbc_th_low_warning_default,omitempty"`
	// Temp Low warning threshold value in the units 0.01 C
	TempLowWarningThreshold int32 `protobuf:"zigzag32,137,opt,name=temp_low_warning_threshold,json=tempLowWarningThreshold,proto3" json:"temp_low_warning_threshold,omitempty"`
	// Temp High warning threshold value in the units of 0.01 C
	TempHighWarningThreshold int32 `protobuf:"zigzag32,138,opt,name=temp_high_warning_threshold,json=tempHighWarningThreshold,proto3" json:"temp_high_warning_threshold,omitempty"`
	// Volt Low warning threshold value
	VoltLowWarningThreshold int32 `protobuf:"zigzag32,139,opt,name=volt_low_warning_threshold,json=voltLowWarningThreshold,proto3" json:"volt_low_warning_threshold,omitempty"`
	// Volt High warning threshold value
	VoltHighWarningThreshold int32    `protobuf:"zigzag32,140,opt,name=volt_high_warning_threshold,json=voltHighWarningThreshold,proto3" json:"volt_high_warning_threshold,omitempty"`
	XXX_NoUnkeyedLiteral     struct{} `json:"-"`
	XXX_unrecognized         []byte   `json:"-"`
	XXX_sizecache            int32    `json:"-"`
}
...
type OpticsTransceiverData struct {
	...
	OpticsVendorRev string `protobuf:"bytes,3,opt,name=optics_vendor_rev,json=opticsVendorRev,proto3" json:"optics_vendor_rev,omitempty"`
	// Transceiver serial number
	OpticsSerialNo string `protobuf:"bytes,4,opt,name=optics_serial_no,json=opticsSerialNo,proto3" json:"optics_serial_no,omitempty"`
	// Transceiver vendors part number
	OpticsVendorPart string `protobuf:"bytes,5,opt,name=optics_vendor_part,json=opticsVendorPart,proto3" json:"optics_vendor_part,omitempty"`
	// Connector type
	...
	OtnApplicationCode string `protobuf:"bytes,7,opt,name=otn_application_code,json=otnApplicationCode,proto3" json:"otn_application_code,omitempty"`
	// Sonet Application Code
	SonetApplicationCode string `protobuf:"bytes,8,opt,name=sonet_application_code,json=sonetApplicationCode,proto3" json:"sonet_application_code,omitempty"`
	// Ethernet Compliance Code
	EthernetComplianceCode string `protobuf:"bytes,9,opt,name=ethernet_compliance_code,json=ethernetComplianceCode,proto3" json:"ethernet_compliance_code,omitempty"`
	// Internal Temperature in C
	InternalTemperature  int32    `protobuf:"zigzag32,10,opt,name=internal_temperature,json=internalTemperature,proto3" json:"internal_temperature,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type OpticsEdmAlarmInfo struct {
	...
	HighTx1Lbc *OpticsAlarmDetail `protobuf:"bytes,22,opt,name=high_tx1_lbc,json=highTx1Lbc,proto3" json:"high_tx1_lbc,omitempty"`
	// High Tx2 laser bias current in units of percentage
	HighTx2Lbc *OpticsAlarmDetail `protobuf:"bytes,23,opt,name=high_tx2_lbc,json=highTx2Lbc,proto3" json:"high_tx2_lbc,omitempty"`
	// High Tx3 laser bias current in units of percentage
	HighTx3Lbc *OpticsAlarmDetail `protobuf:"bytes,24,opt,name=high_tx3_lbc,json=highTx3Lbc,proto3" json:"high_tx3_lbc,omitempty"`
	// High Tx4 laser bias current in units of percentage
	HighTx4Lbc *OpticsAlarmDetail `protobuf:"bytes,25,opt,name=high_tx4_lbc,json=highTx4Lbc,proto3" json:"high_tx4_lbc,omitempty"`
	// Low Tx1 laser bias current in units of percentage
	LowTx1Lbc *OpticsAlarmDetail `protobuf:"bytes,26,opt,name=low_tx1_lbc,json=lowTx1Lbc,proto3" json:"low_tx1_lbc,omitempty"`
	// Low Tx2 laser bias current in units of percentage
	LowTx2Lbc *OpticsAlarmDetail `protobuf:"bytes,27,opt,name=low_tx2_lbc,json=lowTx2Lbc,proto3" json:"low_tx2_lbc,omitempty"`
	// Low Tx3 laser bias current in units of percentage
	LowTx3Lbc *OpticsAlarmDetail `protobuf:"bytes,28,opt,name=low_tx3_lbc,json=lowTx3Lbc,proto3" json:"low_tx3_lbc,omitempty"`
	// Low Tx4 laser bias current in units of percentage
	LowTx4Lbc *OpticsAlarmDetail `protobuf:"bytes,29,opt,name=low_tx4_lbc,json=lowTx4Lbc,proto3" json:"low_tx4_lbc,omitempty"`
	// RX LOS
...
type OpticsExtParam struct {
	...
	PreFecBer int64 `protobuf:"zigzag64,7,opt,name=pre_fec_ber,json=preFecBer,proto3" json:"pre_fec_ber,omitempty"`
	// Uncorrected BER since last counter reset
	UncorrectedBer int64 `protobuf:"zigzag64,8,opt,name=uncorrected_ber,json=uncorrectedBer,proto3" json:"uncorrected_ber,omitempty"`
	...
	PreFecBerLatchedMin int64 `protobuf:"zigzag64,15,opt,name=pre_fec_ber_latched_min,json=preFecBerLatchedMin,proto3" json:"pre_fec_ber_latched_min,omitempty"`
	// Latched maximum Pre FEC BER value since last read, line ingress
	PreFecBerLatchedMax int64 `protobuf:"zigzag64,16,opt,name=pre_fec_ber_latched_max,json=preFecBerLatchedMax,proto3" json:"pre_fec_ber_latched_max,omitempty"`
	// Pre FEC BER value prior accumulation period, line ingress
	PreFecBerAccumulated int64 `protobuf:"zigzag64,17,opt,name=pre_fec_ber_accumulated,json=preFecBerAccumulated,proto3" json:"pre_fec_ber_accumulated,omitempty"`
	// Pre FEC BER value instantaneous line ingress
	PreFecBerInstantaneous int64 `protobuf:"zigzag64,18,opt,name=pre_fec_ber_instantaneous,json=preFecBerInstantaneous,proto3" json:"pre_fec_ber_instantaneous,omitempty"`
	// Latched minimum Uncorrected BER value since last read, line ingress
	UncorrectedBerLatchedMin int64 `protobuf:"zigzag64,19,opt,name=uncorrected_ber_latched_min,json=uncorrectedBerLatchedMin,proto3" json:"uncorrected_ber_latched_min,omitempty"`
	// Latched maximum Uncorrected BER value since last read, line ingress
	UncorrectedBerLatchedMax int64 `protobuf:"zigzag64,20,opt,name=uncorrected_ber_latched_max,json=uncorrectedBerLatchedMax,proto3" json:"uncorrected_ber_latched_max,omitempty"`
	// Uncorrected BER value prior accumulation period, line ingress
	UncorrectedBerAccumulated int64 `protobuf:"zigzag64,21,opt,name=uncorrected_ber_accumulated,json=uncorrectedBerAccumulated,proto3" json:"uncorrected_ber_accumulated,omitempty"`
	// Uncorrected BER value instantaneous line line ingress
	UncorrectedBerInstantaneous int64    `protobuf:"zigzag64,22,opt,name=uncorrected_ber_instantaneous,json=uncorrectedBerInstantaneous,proto3" json:"uncorrected_ber_instantaneous,omitempty"`
	XXX_NoUnkeyedLiteral        struct{} `json:"-"`
	XXX_unrecognized            []byte   `json:"-"`
	XXX_sizecache               int32    `json:"-"`
}
...
type OpticsExtThresholdParam struct {
	...
	PreFecBerAlarmHighThreshold int64 `protobuf:"zigzag64,13,opt,name=pre_fec_ber_alarm_high_threshold,json=preFecBerAlarmHighThreshold,proto3" json:"pre_fec_ber_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Pre FEC BER
	PreFecBerAlarmLowThreshold int64 `protobuf:"zigzag64,14,opt,name=pre_fec_ber_alarm_low_threshold,json=preFecBerAlarmLowThreshold,proto3" json:"pre_fec_ber_alarm_low_threshold,omitempty"`
	// High threshold warning for Pre FEC BER
	PreFecBerWarnHighThreshold int64 `protobuf:"zigzag64,15,opt,name=pre_fec_ber_warn_high_threshold,json=preFecBerWarnHighThreshold,proto3" json:"pre_fec_ber_warn_high_threshold,omitempty"`
	// Low threshold warning for Pre FEC BER
	PreFecBerWarnLowThreshold int64 `protobuf:"zigzag64,16,opt,name=pre_fec_ber_warn_low_threshold,json=preFecBerWarnLowThreshold,proto3" json:"pre_fec_ber_warn_low_threshold,omitempty"`
	// High threshold alarm for Uncorrected BER
	UncorrectedBerAlarmHighThreshold int64 `protobuf:"zigzag64,17,opt,name=uncorrected_ber_alarm_high_threshold,json=uncorrectedBerAlarmHighThreshold,proto3" json:"uncorrected_ber_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Uncorrected BER
	UncorrectedBerAlarmLowThreshold int64 `protobuf:"zigzag64,18,opt,name=uncorrected_ber_alarm_low_threshold,json=uncorrectedBerAlarmLowThreshold,proto3" json:"uncorrected_ber_alarm_low_threshold,omitempty"`
	// High threshold warning for Uncorrected BER
	UncorrectedBerWarnHighThreshold int64 `protobuf:"zigzag64,19,opt,name=uncorrected_ber_warn_high_threshold,json=uncorrectedBerWarnHighThreshold,proto3" json:"uncorrected_ber_warn_high_threshold,omitempty"`
	// Low threshold warning for Uncorrected BER
	UncorrectedBerWarnLowThreshold int64 `protobuf:"zigzag64,20,opt,name=uncorrected_ber_warn_low_threshold,json=uncorrectedBerWarnLowThreshold,proto3" json:"uncorrected_ber_warn_low_threshold,omitempty"`
	...
	PreFecBerLatchedMinAlarmHighThreshold int64 `protobuf:"zigzag64,33,opt,name=pre_fec_ber_latched_min_alarm_high_threshold,json=preFecBerLatchedMinAlarmHighThreshold,proto3" json:"pre_fec_ber_latched_min_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Latched Min Pre FEC BER
	PreFecBerLatchedMinAlarmLowThreshold int64 `protobuf:"zigzag64,34,opt,name=pre_fec_ber_latched_min_alarm_low_threshold,json=preFecBerLatchedMinAlarmLowThreshold,proto3" json:"pre_fec_ber_latched_min_alarm_low_threshold,omitempty"`
	// High threshold warning for Latched Min Pre FEC BER
	PreFecBerLatchedMinWarnHighThreshold int64 `protobuf:"zigzag64,35,opt,name=pre_fec_ber_latched_min_warn_high_threshold,json=preFecBerLatchedMinWarnHighThreshold,proto3" json:"pre_fec_ber_latched_min_warn_high_threshold,omitempty"`
	// Low threshold warning for Latched Min Pre FEC BER
	PreFecBerLatchedMinWarnLowThreshold int64 `protobuf:"zigzag64,36,opt,name=pre_fec_ber_latched_min_warn_low_threshold,json=preFecBerLatchedMinWarnLowThreshold,proto3" json:"pre_fec_ber_latched_min_warn_low_threshold,omitempty"`
	// High threshold alarm for Latched Max Pre FEC BER
	PreFecBerLatchedMaxAlarmHighThreshold int64 `protobuf:"zigzag64,37,opt,name=pre_fec_ber_latched_max_alarm_high_threshold,json=preFecBerLatchedMaxAlarmHighThreshold,proto3" json:"pre_fec_ber_latched_max_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Latched Max Pre FEC BER
	PreFecBerLatchedMaxAlarmLowThreshold int64 `protobuf:"zigzag64,38,opt,name=pre_fec_ber_latched_max_alarm_low_threshold,json=preFecBerLatchedMaxAlarmLowThreshold,proto3" json:"pre_fec_ber_latched_max_alarm_low_threshold,omitempty"`
	// High threshold warning for Latched Max Pre FEC BER
	PreFecBerLatchedMaxWarnHighThreshold int64 `protobuf:"zigzag64,39,opt,name=pre_fec_ber_latched_max_warn_high_threshold,json=preFecBerLatchedMaxWarnHighThreshold,proto3" json:"pre_fec_ber_latched_max_warn_high_threshold,omitempty"`
	// Low threshold warning for Latched Max Pre FEC BER
	PreFecBerLatchedMaxWarnLowThreshold int64 `protobuf:"zigzag64,40,opt,name=pre_fec_ber_latched_max_warn_low_threshold,json=preFecBerLatchedMaxWarnLowThreshold,proto3" json:"pre_fec_ber_latched_max_warn_low_threshold,omitempty"`
	// High threshold alarm for Accumulated Pre FEC BER
	PreFecBerAccumulatedAlarmHighThreshold int64 `protobuf:"zigzag64,41,opt,name=pre_fec_ber_accumulated_alarm_high_threshold,json=preFecBerAccumulatedAlarmHighThreshold,proto3" json:"pre_fec_ber_accumulated_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Accumulated Pre FEC BER
	PreFecBerAccumulatedAlarmLowThreshold int64 `protobuf:"zigzag64,42,opt,name=pre_fec_ber_accumulated_alarm_low_threshold,json=preFecBerAccumulatedAlarmLowThreshold,proto3" json:"pre_fec_ber_accumulated_alarm_low_threshold,omitempty"`
	// High threshold warning for Accumulated Pre FEC BER
	PreFecBerAccumulatedWarnHighThreshold int64 `protobuf:"zigzag64,43,opt,name=pre_fec_ber_accumulated_warn_high_threshold,json=preFecBerAccumulatedWarnHighThreshold,proto3" json:"pre_fec_ber_accumulated_warn_high_threshold,omitempty"`
	// Low threshold warning for Accumulated Pre FEC BER
	PreFecBerAccumulatedWarnLowThreshold int64 `protobuf:"zigzag64,44,opt,name=pre_fec_ber_accumulated_warn_low_threshold,json=preFecBerAccumulatedWarnLowThreshold,proto3" json:"pre_fec_ber_accumulated_warn_low_threshold,omitempty"`
	// High threshold alarm for Instantaneous Pre FEC BER
	PreFecBerInstantaneousAlarmHighThreshold int64 `protobuf:"zigzag64,45,opt,name=pre_fec_ber_instantaneous_alarm_high_threshold,json=preFecBerInstantaneousAlarmHighThreshold,proto3" json:"pre_fec_ber_instantaneous_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Instantaneous Pre FEC BER
	PreFecBerInstantaneousAlarmLowThreshold int64 `protobuf:"zigzag64,46,opt,name=pre_fec_ber_instantaneous_alarm_low_threshold,json=preFecBerInstantaneousAlarmLowThreshold,proto3" json:"pre_fec_ber_instantaneous_alarm_low_threshold,omitempty"`
	// High threshold warning for Instantaneous Pre FEC BER
	PreFecBerInstantaneousWarnHighThreshold int64 `protobuf:"zigzag64,47,opt,name=pre_fec_ber_instantaneous_warn_high_threshold,json=preFecBerInstantaneousWarnHighThreshold,proto3" json:"pre_fec_ber_instantaneous_warn_high_threshold,omitempty"`
	// Low threshold warning for Instantaneous Pre FEC BER
	PreFecBerInstantaneousWarnLowThreshold int64 `protobuf:"zigzag64,48,opt,name=pre_fec_ber_instantaneous_warn_low_threshold,json=preFecBerInstantaneousWarnLowThreshold,proto3" json:"pre_fec_ber_instantaneous_warn_low_threshold,omitempty"`
	// High threshold alarm for  Latched Min Uncorrected BER
	UncorrectedBerLatchedMinAlarmHighThreshold int64 `protobuf:"zigzag64,49,opt,name=uncorrected_ber_latched_min_alarm_high_threshold,json=uncorrectedBerLatchedMinAlarmHighThreshold,proto3" json:"uncorrected_ber_latched_min_alarm_high_threshold,omitempty"`
	// Low threshold alarm for  Latched Min Uncorrected BER
	UncorrectedBerLatchedMinAlarmLowThreshold int64 `protobuf:"zigzag64,50,opt,name=uncorrected_ber_latched_min_alarm_low_threshold,json=uncorrectedBerLatchedMinAlarmLowThreshold,proto3" json:"uncorrected_ber_latched_min_alarm_low_threshold,omitempty"`
	// High threshold warning for  Latched Min Uncorrected BER
	UncorrectedBerLatchedMinWarnHighThreshold int64 `protobuf:"zigzag64,51,opt,name=uncorrected_ber_latched_min_warn_high_threshold,json=uncorrectedBerLatchedMinWarnHighThreshold,proto3" json:"uncorrected_ber_latched_min_warn_high_threshold,omitempty"`
	// Low threshold alarm for Latched Min Uncorrected BER
	UncorrectedBerLatchedMinWarnLowThreshold int64 `protobuf:"zigzag64,52,opt,name=uncorrected_ber_latched_min_warn_low_threshold,json=uncorrectedBerLatchedMinWarnLowThreshold,proto3" json:"uncorrected_ber_latched_min_warn_low_threshold,omitempty"`
	// High threshold alarm for Latched_Max Uncorrected BER
	UncorrectedBerLatchedMaxAlarmHighThreshold int64 `protobuf:"zigzag64,53,opt,name=uncorrected_ber_latched_max_alarm_high_threshold,json=uncorrectedBerLatchedMaxAlarmHighThreshold,proto3" json:"uncorrected_ber_latched_max_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Latched_Max Uncorrected BER
	UncorrectedBerLatchedMaxAlarmLowThreshold int64 `protobuf:"zigzag64,54,opt,name=uncorrected_ber_latched_max_alarm_low_threshold,json=uncorrectedBerLatchedMaxAlarmLowThreshold,proto3" json:"uncorrected_ber_latched_max_alarm_low_threshold,omitempty"`
	// High threshold warning Latched_Max for Uncorrected BER
	UncorrectedBerLatchedMaxWarnHighThreshold int64 `protobuf:"zigzag64,55,opt,name=uncorrected_ber_latched_max_warn_high_threshold,json=uncorrectedBerLatchedMaxWarnHighThreshold,proto3" json:"uncorrected_ber_latched_max_warn_high_threshold,omitempty"`
	// Low threshold warning Latched_Max for Uncorrected BER
	UncorrectedBerLatchedMaxWarnLowThreshold int64 `protobuf:"zigzag64,56,opt,name=uncorrected_ber_latched_max_warn_low_threshold,json=uncorrectedBerLatchedMaxWarnLowThreshold,proto3" json:"uncorrected_ber_latched_max_warn_low_threshold,omitempty"`
	// High threshold alarm for Accumulated Uncorrected BER
	UncorrectedBerAccumulatedAlarmHighThreshold int64 `protobuf:"zigzag64,57,opt,name=uncorrected_ber_accumulated_alarm_high_threshold,json=uncorrectedBerAccumulatedAlarmHighThreshold,proto3" json:"uncorrected_ber_accumulated_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Accumulated Uncorrected BER
	UncorrectedBerAccumulatedAlarmLowThreshold int64 `protobuf:"zigzag64,58,opt,name=uncorrected_ber_accumulated_alarm_low_threshold,json=uncorrectedBerAccumulatedAlarmLowThreshold,proto3" json:"uncorrected_ber_accumulated_alarm_low_threshold,omitempty"`
	// High threshold warning for Accumulated Uncorrected BER
	UncorrectedBerAccumulatedWarnHighThreshold int64 `protobuf:"zigzag64,59,opt,name=uncorrected_ber_accumulated_warn_high_threshold,json=uncorrectedBerAccumulatedWarnHighThreshold,proto3" json:"uncorrected_ber_accumulated_warn_high_threshold,omitempty"`
	// Low threshold warning for Accumulated Uncorrected BER
	UncorrectedBerAccumulatedWarnLowThreshold int64 `protobuf:"zigzag64,60,opt,name=uncorrected_ber_accumulated_warn_low_threshold,json=uncorrectedBerAccumulatedWarnLowThreshold,proto3" json:"uncorrected_ber_accumulated_warn_low_threshold,omitempty"`
	// High threshold alarm for Instantaneous Uncorrected BER
	UncorrectedBerInstantaneousAlarmHighThreshold int64 `protobuf:"zigzag64,61,opt,name=uncorrected_ber_instantaneous_alarm_high_threshold,json=uncorrectedBerInstantaneousAlarmHighThreshold,proto3" json:"uncorrected_ber_instantaneous_alarm_high_threshold,omitempty"`
	// Low threshold alarm for Instantaneous Uncorrected BER
	UncorrectedBerInstantaneousAlarmLowThreshold int64 `protobuf:"zigzag64,62,opt,name=uncorrected_ber_instantaneous_alarm_low_threshold,json=uncorrectedBerInstantaneousAlarmLowThreshold,proto3" json:"uncorrected_ber_instantaneous_alarm_low_threshold,omitempty"`
	// High threshold warning for Instantaneous Uncorrected BER
	UncorrectedBerInstantaneousWarnHighThreshold int64 `protobuf:"zigzag64,63,opt,name=uncorrected_ber_instantaneous_warn_high_threshold,json=uncorrectedBerInstantaneousWarnHighThreshold,proto3" json:"uncorrected_ber_instantaneous_warn_high_threshold,omitempty"`
	// Low threshold warning for Instantaneous Uncorrected BER
	UncorrectedBerInstantaneousWarnLowThreshold int64    `protobuf:"zigzag64,64,opt,name=uncorrected_ber_instantaneous_warn_low_threshold,json=uncorrectedBerInstantaneousWarnLowThreshold,proto3" json:"uncorrected_ber_instantaneous_warn_low_threshold,omitempty"`
	XXX_NoUnkeyedLiteral                        struct{} `json:"-"`
	XXX_unrecognized                            []byte   `json:"-"`
	XXX_sizecache                               int32    `json:"-"`
}
