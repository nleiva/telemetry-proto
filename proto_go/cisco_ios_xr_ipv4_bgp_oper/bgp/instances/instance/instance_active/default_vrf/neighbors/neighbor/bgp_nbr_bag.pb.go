...
func (*BgpNbrBag_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{0}
}
...
type BgpNbrBag struct {
	...
	AfData []*NbrAfP `protobuf:"bytes,160,rep,name=af_data,json=afData,proto3" json:"af_data,omitempty"`
...
func (*BgpNbrBag) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{1}
}
...
func (*BgpTimespec) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{2}
}
...
func (*IPV4TunnelAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{3}
}
...
func (*IPV4MDTAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{4}
}
...
func (*RTConstraintAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{5}
}
...
func (*IPV6AddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{6}
}
...
func (*BgpL2VpnAddrT) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{7}
}
...
func (*L2VPNEVPNAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{8}
}
...
func (*BgpL2VpnMspwAddrT) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{9}
}
...
func (*IPV6MVPNAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{10}
}
...
func (*IPV4MVPNAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{11}
}
...
func (*LS_LSAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{12}
}
...
func (*IPv4FlowspecAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{13}
}
...
func (*IPv6FlowspecAddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{14}
}
...
func (*BgpAddrtype) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{15}
}
...
func (*BgpPerfNbrAf_) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{16}
}
...
func (*BgpPerfNbr_) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{17}
}
...
func (*BgpNbrGshut_) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{18}
}
...
type BgpNbrAf_ struct {
	...
	AdvertiseEvpNv4AfiDefVrfImpDisable            bool           `protobuf:"varint,22,opt,name=advertise_evp_nv4_afi_def_vrf_imp_disable,json=advertiseEvpNv4AfiDefVrfImpDisable,proto3" json:"advertise_evp_nv4_afi_def_vrf_imp_disable,omitempty"`
	AdvertiseEvpNv6AfiDefVrfImpDisable            bool           `protobuf:"varint,23,opt,name=advertise_evp_nv6_afi_def_vrf_imp_disable,json=advertiseEvpNv6AfiDefVrfImpDisable,proto3" json:"advertise_evp_nv6_afi_def_vrf_imp_disable,omitempty"`
	AdvertiseAfiEoRReady                          bool           `protobuf:"varint,24,opt,name=advertise_afi_eo_r_ready,json=advertiseAfiEoRReady,proto3" json:"advertise_afi_eo_r_ready,omitempty"`
	AlwaysUseNextHopLocal                         bool           `protobuf:"varint,25,opt,name=always_use_next_hop_local,json=alwaysUseNextHopLocal,proto3" json:"always_use_next_hop_local,omitempty"`
	SentCommunityToNeighbor                       bool           `protobuf:"varint,26,opt,name=sent_community_to_neighbor,json=sentCommunityToNeighbor,proto3" json:"sent_community_to_neighbor,omitempty"`
	SentGshutCommunityToNeighbor                  bool           `protobuf:"varint,27,opt,name=sent_gshut_community_to_neighbor,json=sentGshutCommunityToNeighbor,proto3" json:"sent_gshut_community_to_neighbor,omitempty"`
	SentExtendedCommunityToNeighbor               bool           `protobuf:"varint,28,opt,name=sent_extended_community_to_neighbor,json=sentExtendedCommunityToNeighbor,proto3" json:"sent_extended_community_to_neighbor,omitempty"`
	NeighborDefaultOriginate                      bool           `protobuf:"varint,29,opt,name=neighbor_default_originate,json=neighborDefaultOriginate,proto3" json:"neighbor_default_originate,omitempty"`
	IsOrfSent                                     bool           `protobuf:"varint,30,opt,name=is_orf_sent,json=isOrfSent,proto3" json:"is_orf_sent,omitempty"`
	IsUpdateDeferred                              bool           `protobuf:"varint,31,opt,name=is_update_deferred,json=isUpdateDeferred,proto3" json:"is_update_deferred,omitempty"`
	IsOrfSendScheduled                            bool           `protobuf:"varint,32,opt,name=is_orf_send_scheduled,json=isOrfSendScheduled,proto3" json:"is_orf_send_scheduled,omitempty"`
	UpdateGroupNumber                             uint32         `protobuf:"varint,33,opt,name=update_group_number,json=updateGroupNumber,proto3" json:"update_group_number,omitempty"`
	FilterGroupIndex                              uint32         `protobuf:"varint,34,opt,name=filter_group_index,json=filterGroupIndex,proto3" json:"filter_group_index,omitempty"`
	IsUpdateThrottled                             bool           `protobuf:"varint,35,opt,name=is_update_throttled,json=isUpdateThrottled,proto3" json:"is_update_throttled,omitempty"`
	IsUpdateLeaving                               bool           `protobuf:"varint,36,opt,name=is_update_leaving,json=isUpdateLeaving,proto3" json:"is_update_leaving,omitempty"`
	VpnUpdateGenEnabled                           bool           `protobuf:"varint,37,opt,name=vpn_update_gen_enabled,json=vpnUpdateGenEnabled,proto3" json:"vpn_update_gen_enabled,omitempty"`
	VpnUpdateGenTriggerEnabled                    bool           `protobuf:"varint,38,opt,name=vpn_update_gen_trigger_enabled,json=vpnUpdateGenTriggerEnabled,proto3" json:"vpn_update_gen_trigger_enabled,omitempty"`
	IsAddpathSendOperational                      bool           `protobuf:"varint,39,opt,name=is_addpath_send_operational,json=isAddpathSendOperational,proto3" json:"is_addpath_send_operational,omitempty"`
	IsAddpathReceiveOperational                   bool           `protobuf:"varint,40,opt,name=is_addpath_receive_operational,json=isAddpathReceiveOperational,proto3" json:"is_addpath_receive_operational,omitempty"`
	NeighborVersion                               uint32         `protobuf:"varint,41,opt,name=neighbor_version,json=neighborVersion,proto3" json:"neighbor_version,omitempty"`
	Weight                                        uint32         `protobuf:"varint,42,opt,name=weight,proto3" json:"weight,omitempty"`
	MaxPrefixLimit                                uint32         `protobuf:"varint,43,opt,name=max_prefix_limit,json=maxPrefixLimit,proto3" json:"max_prefix_limit,omitempty"`
	UseMaxPrefixWarningOnly                       bool           `protobuf:"varint,44,opt,name=use_max_prefix_warning_only,json=useMaxPrefixWarningOnly,proto3" json:"use_max_prefix_warning_only,omitempty"`
	MaxPrefixDiscardExtraPaths                    bool           `protobuf:"varint,45,opt,name=max_prefix_discard_extra_paths,json=maxPrefixDiscardExtraPaths,proto3" json:"max_prefix_discard_extra_paths,omitempty"`
	MaxPrefixExceedDiscardPaths                   bool           `protobuf:"varint,46,opt,name=max_prefix_exceed_discard_paths,json=maxPrefixExceedDiscardPaths,proto3" json:"max_prefix_exceed_discard_paths,omitempty"`
	MaxPrefixThresholdPercent                     uint32         `protobuf:"varint,47,opt,name=max_prefix_threshold_percent,json=maxPrefixThresholdPercent,proto3" json:"max_prefix_threshold_percent,omitempty"`
	MaxPrefixRestartTime                          uint32         `protobuf:"varint,48,opt,name=max_prefix_restart_time,json=maxPrefixRestartTime,proto3" json:"max_prefix_restart_time,omitempty"`
	PrefixesAccepted                              uint32         `protobuf:"varint,49,opt,name=prefixes_accepted,json=prefixesAccepted,proto3" json:"prefixes_accepted,omitempty"`
	PrefixesSynced                                uint32         `protobuf:"varint,50,opt,name=prefixes_synced,json=prefixesSynced,proto3" json:"prefixes_synced,omitempty"`
	PrefixesWithdrawnNotFound                     uint32         `protobuf:"varint,51,opt,name=prefixes_withdrawn_not_found,json=prefixesWithdrawnNotFound,proto3" json:"prefixes_withdrawn_not_found,omitempty"`
	PrefixesDenied                                uint32         `protobuf:"varint,52,opt,name=prefixes_denied,json=prefixesDenied,proto3" json:"prefixes_denied,omitempty"`
	PrefixesDeniedNoPolicy                        uint32         `protobuf:"varint,53,opt,name=prefixes_denied_no_policy,json=prefixesDeniedNoPolicy,proto3" json:"prefixes_denied_no_policy,omitempty"`
	PrefixesDeniedRtPermit                        uint32         `protobuf:"varint,54,opt,name=prefixes_denied_rt_permit,json=prefixesDeniedRtPermit,proto3" json:"prefixes_denied_rt_permit,omitempty"`
	PrefixesDeniedOrfPolicy                       uint32         `protobuf:"varint,55,opt,name=prefixes_denied_orf_policy,json=prefixesDeniedOrfPolicy,proto3" json:"prefixes_denied_orf_policy,omitempty"`
	PrefixesDeniedPolicy                          uint32         `protobuf:"varint,56,opt,name=prefixes_denied_policy,json=prefixesDeniedPolicy,proto3" json:"prefixes_denied_policy,omitempty"`
	NumberOfBestpaths                             uint32         `protobuf:"varint,57,opt,name=number_of_bestpaths,json=numberOfBestpaths,proto3" json:"number_of_bestpaths,omitempty"`
	NumberOfBestExternalpaths                     uint32         `protobuf:"varint,58,opt,name=number_of_best_externalpaths,json=numberOfBestExternalpaths,proto3" json:"number_of_best_externalpaths,omitempty"`
	PrefixesAdvertised                            uint32         `protobuf:"varint,59,opt,name=prefixes_advertised,json=prefixesAdvertised,proto3" json:"prefixes_advertised,omitempty"`
	PrefixesBeAdvertised                          uint32         `protobuf:"varint,60,opt,name=prefixes_be_advertised,json=prefixesBeAdvertised,proto3" json:"prefixes_be_advertised,omitempty"`
	PrefixesSuppressed                            uint32         `protobuf:"varint,61,opt,name=prefixes_suppressed,json=prefixesSuppressed,proto3" json:"prefixes_suppressed,omitempty"`
	PrefixesWithdrawn                             uint32         `protobuf:"varint,62,opt,name=prefixes_withdrawn,json=prefixesWithdrawn,proto3" json:"prefixes_withdrawn,omitempty"`
	IsPeerOrfCapable                              bool           `protobuf:"varint,63,opt,name=is_peer_orf_capable,json=isPeerOrfCapable,proto3" json:"is_peer_orf_capable,omitempty"`
	IsAdvertisedOrfSend                           bool           `protobuf:"varint,64,opt,name=is_advertised_orf_send,json=isAdvertisedOrfSend,proto3" json:"is_advertised_orf_send,omitempty"`
	IsReceivedOrfSendCapable                      bool           `protobuf:"varint,65,opt,name=is_received_orf_send_capable,json=isReceivedOrfSendCapable,proto3" json:"is_received_orf_send_capable,omitempty"`
	IsAdvertisedOrfReceive                        bool           `protobuf:"varint,66,opt,name=is_advertised_orf_receive,json=isAdvertisedOrfReceive,proto3" json:"is_advertised_orf_receive,omitempty"`
	IsReceivedOrfReceiveCapable                   bool           `protobuf:"varint,67,opt,name=is_received_orf_receive_capable,json=isReceivedOrfReceiveCapable,proto3" json:"is_received_orf_receive_capable,omitempty"`
	IsAdvertisedGracefulRestart                   bool           `protobuf:"varint,68,opt,name=is_advertised_graceful_restart,json=isAdvertisedGracefulRestart,proto3" json:"is_advertised_graceful_restart,omitempty"`
	IsGracefulRestartStateFlag                    bool           `protobuf:"varint,69,opt,name=is_graceful_restart_state_flag,json=isGracefulRestartStateFlag,proto3" json:"is_graceful_restart_state_flag,omitempty"`
	IsReceivedGracefulRestartCapable              bool           `protobuf:"varint,70,opt,name=is_received_graceful_restart_capable,json=isReceivedGracefulRestartCapable,proto3" json:"is_received_graceful_restart_capable,omitempty"`
	IsAddPathSendCapabilityAdvertised             bool           `protobuf:"varint,71,opt,name=is_add_path_send_capability_advertised,json=isAddPathSendCapabilityAdvertised,proto3" json:"is_add_path_send_capability_advertised,omitempty"`
	IsAddPathSendCapabilityReceived               bool           `protobuf:"varint,72,opt,name=is_add_path_send_capability_received,json=isAddPathSendCapabilityReceived,proto3" json:"is_add_path_send_capability_received,omitempty"`
	IsAddPathReceiveCapabilityAdvertised          bool           `protobuf:"varint,73,opt,name=is_add_path_receive_capability_advertised,json=isAddPathReceiveCapabilityAdvertised,proto3" json:"is_add_path_receive_capability_advertised,omitempty"`
	IsAddPathReceiveCapabilityReceived            bool           `protobuf:"varint,74,opt,name=is_add_path_receive_capability_received,json=isAddPathReceiveCapabilityReceived,proto3" json:"is_add_path_receive_capability_received,omitempty"`
	RestartTime                                   uint32         `protobuf:"varint,75,opt,name=restart_time,json=restartTime,proto3" json:"restart_time,omitempty"`
	LocalRestartTime                              uint32         `protobuf:"varint,76,opt,name=local_restart_time,json=localRestartTime,proto3" json:"local_restart_time,omitempty"`
	StalePathTimeout                              uint32         `protobuf:"varint,77,opt,name=stale_path_timeout,json=stalePathTimeout,proto3" json:"stale_path_timeout,omitempty"`
	RibPurgeTimeoutValue                          uint32         `protobuf:"varint,78,opt,name=rib_purge_timeout_value,json=ribPurgeTimeoutValue,proto3" json:"rib_purge_timeout_value,omitempty"`
	NeighborPreservedForwardingState              bool           `protobuf:"varint,79,opt,name=neighbor_preserved_forwarding_state,json=neighborPreservedForwardingState,proto3" json:"neighbor_preserved_forwarding_state,omitempty"`
	LongLivedGracefulRestartStaleTimeConfigured   bool           `protobuf:"varint,80,opt,name=long_lived_graceful_restart_stale_time_configured,json=longLivedGracefulRestartStaleTimeConfigured,proto3" json:"long_lived_graceful_restart_stale_time_configured,omitempty"`
	LongLivedGracefulRestartStaleTimeSent         uint32         `protobuf:"varint,81,opt,name=long_lived_graceful_restart_stale_time_sent,json=longLivedGracefulRestartStaleTimeSent,proto3" json:"long_lived_graceful_restart_stale_time_sent,omitempty"`
	LongLivedGracefulRestartStaleTimeAccept       uint32         `protobuf:"varint,82,opt,name=long_lived_graceful_restart_stale_time_accept,json=longLivedGracefulRestartStaleTimeAccept,proto3" json:"long_lived_graceful_restart_stale_time_accept,omitempty"`
	LongLivedGracefulRestartCapabilityReceived    bool           `protobuf:"varint,83,opt,name=long_lived_graceful_restart_capability_received,json=longLivedGracefulRestartCapabilityReceived,proto3" json:"long_lived_graceful_restart_capability_received,omitempty"`
	LongLivedGracefulRestartStaleTimeReceived     uint32         `protobuf:"varint,84,opt,name=long_lived_graceful_restart_stale_time_received,json=longLivedGracefulRestartStaleTimeReceived,proto3" json:"long_lived_graceful_restart_stale_time_received,omitempty"`
	NeighborPreservedLongLivedForwardingState     bool           `protobuf:"varint,85,opt,name=neighbor_preserved_long_lived_forwarding_state,json=neighborPreservedLongLivedForwardingState,proto3" json:"neighbor_preserved_long_lived_forwarding_state,omitempty"`
	NeighborLongLivedGracefulRestartCapable       bool           `protobuf:"varint,86,opt,name=neighbor_long_lived_graceful_restart_capable,json=neighborLongLivedGracefulRestartCapable,proto3" json:"neighbor_long_lived_graceful_restart_capable,omitempty"`
	NeighborLongLivedGracefulRestartTimeRemaining uint32         `protobuf:"varint,87,opt,name=neighbor_long_lived_graceful_restart_time_remaining,json=neighborLongLivedGracefulRestartTimeRemaining,proto3" json:"neighbor_long_lived_graceful_restart_time_remaining,omitempty"`
	RouteRefreshesReceived                        uint32         `protobuf:"varint,88,opt,name=route_refreshes_received,json=routeRefreshesReceived,proto3" json:"route_refreshes_received,omitempty"`
	RouteRefreshesSent                            uint32         `protobuf:"varint,89,opt,name=route_refreshes_sent,json=routeRefreshesSent,proto3" json:"route_refreshes_sent,omitempty"`
	RefreshTargetVersion                          uint32         `protobuf:"varint,90,opt,name=refresh_target_version,json=refreshTargetVersion,proto3" json:"refresh_target_version,omitempty"`
	RefreshVersion                                uint32         `protobuf:"varint,91,opt,name=refresh_version,json=refreshVersion,proto3" json:"refresh_version,omitempty"`
	RefreshAckedVersion                           uint32         `protobuf:"varint,92,opt,name=refresh_acked_version,json=refreshAckedVersion,proto3" json:"refresh_acked_version,omitempty"`
	IsPrefixOrfPresent                            bool           `protobuf:"varint,93,opt,name=is_prefix_orf_present,json=isPrefixOrfPresent,proto3" json:"is_prefix_orf_present,omitempty"`
	OrfEntriesReceived                            uint32         `protobuf:"varint,94,opt,name=orf_entries_received,json=orfEntriesReceived,proto3" json:"orf_entries_received,omitempty"`
	IsDefaultOriginateSent                        bool           `protobuf:"varint,95,opt,name=is_default_originate_sent,json=isDefaultOriginateSent,proto3" json:"is_default_originate_sent,omitempty"`
	RoutePolicyPrefixOrf                          string         `protobuf:"bytes,96,opt,name=route_policy_prefix_orf,json=routePolicyPrefixOrf,proto3" json:"route_policy_prefix_orf,omitempty"`
	RoutePolicyIn                                 string         `protobuf:"bytes,97,opt,name=route_policy_in,json=routePolicyIn,proto3" json:"route_policy_in,omitempty"`
	RoutePolicyOut                                string         `protobuf:"bytes,98,opt,name=route_policy_out,json=routePolicyOut,proto3" json:"route_policy_out,omitempty"`
	RoutePolicyDefaultOriginate                   string         `protobuf:"bytes,99,opt,name=route_policy_default_originate,json=routePolicyDefaultOriginate,proto3" json:"route_policy_default_originate,omitempty"`
	IsNeighborEbgpWithoutInboundPolicy            bool           `protobuf:"varint,100,opt,name=is_neighbor_ebgp_without_inbound_policy,json=isNeighborEbgpWithoutInboundPolicy,proto3" json:"is_neighbor_ebgp_without_inbound_policy,omitempty"`
	IsNeighborEbgpWithoutOutboundPolicy           bool           `protobuf:"varint,101,opt,name=is_neighbor_ebgp_without_outbound_policy,json=isNeighborEbgpWithoutOutboundPolicy,proto3" json:"is_neighbor_ebgp_without_outbound_policy,omitempty"`
	IsAsOverrideSet                               bool           `protobuf:"varint,102,opt,name=is_as_override_set,json=isAsOverrideSet,proto3" json:"is_as_override_set,omitempty"`
	IsAllowAsInSet                                bool           `protobuf:"varint,103,opt,name=is_allow_as_in_set,json=isAllowAsInSet,proto3" json:"is_allow_as_in_set,omitempty"`
	AllowAsInCount                                uint32         `protobuf:"varint,104,opt,name=allow_as_in_count,json=allowAsInCount,proto3" json:"allow_as_in_count,omitempty"`
	AddressFamilyLongLivedTime                    uint32         `protobuf:"varint,105,opt,name=address_family_long_lived_time,json=addressFamilyLongLivedTime,proto3" json:"address_family_long_lived_time,omitempty"`
	EoRReceivedInReadOnly                         bool           `protobuf:"varint,106,opt,name=eo_r_received_in_read_only,json=eoRReceivedInReadOnly,proto3" json:"eo_r_received_in_read_only,omitempty"`
	AckedVersion                                  uint32         `protobuf:"varint,107,opt,name=acked_version,json=ackedVersion,proto3" json:"acked_version,omitempty"`
	SyncedAckedVersion                            uint32         `protobuf:"varint,108,opt,name=synced_acked_version,json=syncedAckedVersion,proto3" json:"synced_acked_version,omitempty"`
	OutstandingVersion                            uint32         `protobuf:"varint,109,opt,name=outstanding_version,json=outstandingVersion,proto3" json:"outstanding_version,omitempty"`
	OutstandingVersionMax                         uint32         `protobuf:"varint,110,opt,name=outstanding_version_max,json=outstandingVersionMax,proto3" json:"outstanding_version_max,omitempty"`
	NeighborAfPerformanceStatistics               *BgpPerfNbrAf_ `protobuf:"bytes,111,opt,name=neighbor_af_performance_statistics,json=neighborAfPerformanceStatistics,proto3" json:"neighbor_af_performance_statistics,omitempty"`
	IsAigpSet                                     bool           `protobuf:"varint,112,opt,name=is_aigp_set,json=isAigpSet,proto3" json:"is_aigp_set,omitempty"`
	IsRtPresent                                   bool           `protobuf:"varint,113,opt,name=is_rt_present,json=isRtPresent,proto3" json:"is_rt_present,omitempty"`
	ExtendedCommunity                             []uint32       `protobuf:"varint,114,rep,packed,name=extended_community,json=extendedCommunity,proto3" json:"extended_community,omitempty"`
	IsRtPresentStandby                            bool           `protobuf:"varint,115,opt,name=is_rt_present_standby,json=isRtPresentStandby,proto3" json:"is_rt_present_standby,omitempty"`
	ExtendedCommunityStandby                      []uint32       `protobuf:"varint,116,rep,packed,name=extended_community_standby,json=extendedCommunityStandby,proto3" json:"extended_community_standby,omitempty"`
	AcceptOwnEnabled                              bool           `protobuf:"varint,117,opt,name=accept_own_enabled,json=acceptOwnEnabled,proto3" json:"accept_own_enabled,omitempty"`
	SelectiveMultipathEligible                    bool           `protobuf:"varint,118,opt,name=selective_multipath_eligible,json=selectiveMultipathEligible,proto3" json:"selective_multipath_eligible,omitempty"`
	AfrpkiDisable                                 bool           `protobuf:"varint,119,opt,name=afrpki_disable,json=afrpkiDisable,proto3" json:"afrpki_disable,omitempty"`
	AfrpkiUseValidity                             bool           `protobuf:"varint,120,opt,name=afrpki_use_validity,json=afrpkiUseValidity,proto3" json:"afrpki_use_validity,omitempty"`
	AfrpkiAllowInvalid                            bool           `protobuf:"varint,121,opt,name=afrpki_allow_invalid,json=afrpkiAllowInvalid,proto3" json:"afrpki_allow_invalid,omitempty"`
	AfrpkiSignalIbgp                              bool           `protobuf:"varint,122,opt,name=afrpki_signal_ibgp,json=afrpkiSignalIbgp,proto3" json:"afrpki_signal_ibgp,omitempty"`
	IsAdvertisePermanentNetwork                   bool           `protobuf:"varint,123,opt,name=is_advertise_permanent_network,json=isAdvertisePermanentNetwork,proto3" json:"is_advertise_permanent_network,omitempty"`
	IsSendMcastAttr                               bool           `protobuf:"varint,124,opt,name=is_send_mcast_attr,json=isSendMcastAttr,proto3" json:"is_send_mcast_attr,omitempty"`
	ImportStitching                               bool           `protobuf:"varint,125,opt,name=import_stitching,json=importStitching,proto3" json:"import_stitching,omitempty"`
	ImportReoriginate                             bool           `protobuf:"varint,126,opt,name=import_reoriginate,json=importReoriginate,proto3" json:"import_reoriginate,omitempty"`
	ImportReoriginateStitching                    bool           `protobuf:"varint,127,opt,name=import_reoriginate_stitching,json=importReoriginateStitching,proto3" json:"import_reoriginate_stitching,omitempty"`
	AdvertiseV4Flags                              uint32         `protobuf:"varint,128,opt,name=advertise_v4_flags,json=advertiseV4Flags,proto3" json:"advertise_v4_flags,omitempty"`
	AdvertiseV6Flags                              uint32         `protobuf:"varint,129,opt,name=advertise_v6_flags,json=advertiseV6Flags,proto3" json:"advertise_v6_flags,omitempty"`
	AdvertiseLocalLabeledRouteUnicast             bool           `protobuf:"varint,130,opt,name=advertise_local_labeled_route_unicast,json=advertiseLocalLabeledRouteUnicast,proto3" json:"advertise_local_labeled_route_unicast,omitempty"`
	XXX_NoUnkeyedLiteral                          struct{}       `json:"-"`
	XXX_unrecognized                              []byte         `json:"-"`
	XXX_sizecache                                 int32          `json:"-"`
}
...
func (*BgpNbrAf_) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{19}
}
...
type NbrAfP struct {
	Value                *BgpNbrAf_ `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*NbrAfP) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{20}
}
...
func (m *NbrAfP) XXX_DiscardUnknown() {
	xxx_messageInfo_NbrAfP.DiscardUnknown(m)
}

var xxx_messageInfo_NbrAfP proto.InternalMessageInfo
...
func (*BgpNotfntype_) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{21}
}
...
func (*BgpNbrMsgStatsUnit) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{22}
}
...
func (*BgpNbrMsgStatsOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{23}
}
...
func (*BgpNbrMsgStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_bgp_nbr_bag_58779594ae94925c, []int{24}
}
...
func init() { proto.RegisterFile("bgp_nbr_bag.proto", fileDescriptor_bgp_nbr_bag_58779594ae94925c) }

var fileDescriptor_bgp_nbr_bag_58779594ae94925c = []byte{
