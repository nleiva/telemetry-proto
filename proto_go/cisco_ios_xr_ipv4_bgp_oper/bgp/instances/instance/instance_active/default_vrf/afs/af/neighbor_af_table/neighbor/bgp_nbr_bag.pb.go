...
type BgpNbrAf_ struct {
	...
	AdvertiseEvpNv4AfiVrfReImpDisable             bool           `protobuf:"varint,25,opt,name=advertise_evp_nv4_afi_vrf_re_imp_disable,json=advertiseEvpNv4AfiVrfReImpDisable,proto3" json:"advertise_evp_nv4_afi_vrf_re_imp_disable,omitempty"`
	AdvertiseEvpNv6AfiVrfReImpDisable             bool           `protobuf:"varint,26,opt,name=advertise_evp_nv6_afi_vrf_re_imp_disable,json=advertiseEvpNv6AfiVrfReImpDisable,proto3" json:"advertise_evp_nv6_afi_vrf_re_imp_disable,omitempty"`
