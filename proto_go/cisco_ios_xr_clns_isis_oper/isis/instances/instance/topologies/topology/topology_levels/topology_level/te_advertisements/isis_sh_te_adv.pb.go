...
func (m *IsisShTeAdvSubTlvP) XXX_DiscardUnknown() {
	xxx_messageInfo_IsisShTeAdvSubTlvP.DiscardUnknown(m)
}

var xxx_messageInfo_IsisShTeAdvSubTlvP proto.InternalMessageInfo
...
func (m *IsisShTeAdvEntryP) XXX_DiscardUnknown() {
	xxx_messageInfo_IsisShTeAdvEntryP.DiscardUnknown(m)
}

var xxx_messageInfo_IsisShTeAdvEntryP proto.InternalMessageInfo
