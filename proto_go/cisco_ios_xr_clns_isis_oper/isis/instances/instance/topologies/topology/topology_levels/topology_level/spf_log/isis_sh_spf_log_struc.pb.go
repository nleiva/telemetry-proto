...
func (m *IsisSystemIdType) XXX_DiscardUnknown() {
	xxx_messageInfo_IsisSystemIdType.DiscardUnknown(m)
}

var xxx_messageInfo_IsisSystemIdType proto.InternalMessageInfo
...
func (m *IsisLspIdType) XXX_DiscardUnknown() {
	xxx_messageInfo_IsisLspIdType.DiscardUnknown(m)
}

var xxx_messageInfo_IsisLspIdType proto.InternalMessageInfo
