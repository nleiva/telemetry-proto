...
func (m *IsisShMeshEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_IsisShMeshEntry.DiscardUnknown(m)
}

var xxx_messageInfo_IsisShMeshEntry proto.InternalMessageInfo
