...
func (*Ipv6Dhcpv6DServerBindingOptions_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_dhcpv6d_server_binding_options_c9d21444375c16a8, []int{0}
}
...
func (*Ipv6Dhcpv6DServerBindingOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_dhcpv6d_server_binding_options_c9d21444375c16a8, []int{1}
}
...
func (*IPV6AddressType) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_dhcpv6d_server_binding_options_c9d21444375c16a8, []int{2}
}
...
func init() {
	proto.RegisterFile("ipv6_dhcpv6d_server_binding_options.proto", fileDescriptor_ipv6_dhcpv6d_server_binding_options_c9d21444375c16a8)
}

var fileDescriptor_ipv6_dhcpv6d_server_binding_options_c9d21444375c16a8 = []byte{
