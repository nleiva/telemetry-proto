...
func (*QosStats_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{0}
}
...
func (*QosStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{1}
}
...
func (*PolicyParamUint32St_) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{2}
}
...
func (*GenStatsSt) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{3}
}
...
func (*PlcColorClassStatsSt) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{4}
}
...
func (*PlcStatsSt) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{5}
}
...
func (*CacStatsSt) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{6}
}
...
func (*IphcStatsSt) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{7}
}
...
func (*QStatsSt) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{8}
}
...
func (*WredTypeValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{9}
}
...
func (*RedProfileStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{10}
}
...
func (*ClassStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_stats_550921a74220f353, []int{11}
}
...
func init() { proto.RegisterFile("qos_stats.proto", fileDescriptor_qos_stats_550921a74220f353) }

var fileDescriptor_qos_stats_550921a74220f353 = []byte{
