...
func (*QosMaSatIfEdmInfoXml_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_ma_sat_if_edm_info_xml_8d701d0f0ba78af6, []int{0}
}
...
func (*QosMaSatIfEdmInfoXml) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_ma_sat_if_edm_info_xml_8d701d0f0ba78af6, []int{1}
}
...
func init() {
	proto.RegisterFile("qos_ma_sat_if_edm_info_xml.proto", fileDescriptor_qos_ma_sat_if_edm_info_xml_8d701d0f0ba78af6)
}

var fileDescriptor_qos_ma_sat_if_edm_info_xml_8d701d0f0ba78af6 = []byte{
