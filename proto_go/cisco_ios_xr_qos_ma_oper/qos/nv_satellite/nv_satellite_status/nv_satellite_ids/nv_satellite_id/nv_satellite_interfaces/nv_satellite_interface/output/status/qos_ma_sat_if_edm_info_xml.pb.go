...
func (*QosMaSatIfEdmInfoXml_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_ma_sat_if_edm_info_xml_01cfbafb0eee7c6d, []int{0}
}
...
func (*QosMaSatIfEdmInfoXml) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_ma_sat_if_edm_info_xml_01cfbafb0eee7c6d, []int{1}
}
...
func init() {
	proto.RegisterFile("qos_ma_sat_if_edm_info_xml.proto", fileDescriptor_qos_ma_sat_if_edm_info_xml_01cfbafb0eee7c6d)
}

var fileDescriptor_qos_ma_sat_if_edm_info_xml_01cfbafb0eee7c6d = []byte{
