...
func (*QosMaSatIfEdmInfoXml_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_ma_sat_if_edm_info_xml_54e8ac7eb8c9b904, []int{0}
}
...
func (dst *QosMaSatIfEdmInfoXml_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QosMaSatIfEdmInfoXml_KEYS.Merge(dst, src)
}
...
func (*QosMaSatIfEdmInfoXml) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_ma_sat_if_edm_info_xml_54e8ac7eb8c9b904, []int{1}
}
...
func (dst *QosMaSatIfEdmInfoXml) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QosMaSatIfEdmInfoXml.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("qos_ma_sat_if_edm_info_xml.proto", fileDescriptor_qos_ma_sat_if_edm_info_xml_54e8ac7eb8c9b904)
}

var fileDescriptor_qos_ma_sat_if_edm_info_xml_54e8ac7eb8c9b904 = []byte{
