...
func (*QosMaSatIfEdmInfoXml_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_ma_sat_if_edm_info_xml_59c210a2925eac3e, []int{0}
}
...
func (*QosMaSatIfEdmInfoXml) Descriptor() ([]byte, []int) {
	return fileDescriptor_qos_ma_sat_if_edm_info_xml_59c210a2925eac3e, []int{1}
}
...
func init() {
	proto.RegisterFile("qos_ma_sat_if_edm_info_xml.proto", fileDescriptor_qos_ma_sat_if_edm_info_xml_59c210a2925eac3e)
}

var fileDescriptor_qos_ma_sat_if_edm_info_xml_59c210a2925eac3e = []byte{
