...
func (*Ipv6AclEdmOorDetail_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_acl_edm_oor_detail_f3c9a6f57f07a256, []int{0}
}
...
func (*Ipv6AclEdmOorDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_acl_edm_oor_detail_f3c9a6f57f07a256, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv6_acl_edm_oor_detail.proto", fileDescriptor_ipv6_acl_edm_oor_detail_f3c9a6f57f07a256)
}

var fileDescriptor_ipv6_acl_edm_oor_detail_f3c9a6f57f07a256 = []byte{
