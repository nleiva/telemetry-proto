...
func (*FibShTblExtClientSum_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_fib_sh_tbl_ext_client_sum_4c1215fc1b36fad1, []int{0}
}
...
func (dst *FibShTblExtClientSum_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FibShTblExtClientSum_KEYS.Merge(dst, src)
}
...
func (*FibShTblExtClientSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_fib_sh_tbl_ext_client_sum_4c1215fc1b36fad1, []int{1}
}
...
func (dst *FibShTblExtClientSum) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FibShTblExtClientSum.Merge(dst, src)
}
...
func (*FibShTblExtPlSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_fib_sh_tbl_ext_client_sum_4c1215fc1b36fad1, []int{2}
}
...
func init() {
	proto.RegisterFile("fib_sh_tbl_ext_client_sum.proto", fileDescriptor_fib_sh_tbl_ext_client_sum_4c1215fc1b36fad1)
}

var fileDescriptor_fib_sh_tbl_ext_client_sum_4c1215fc1b36fad1 = []byte{
