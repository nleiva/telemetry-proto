...
func (*CdpNeighbor_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{0}
}
...
func (*CdpNeighbor) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{1}
}
...
func (*CdpNeighborItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{2}
}
...
func (*In6AddrTd) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{3}
}
...
func (*CdpL3Addr) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{4}
}
...
func (*CdpAddrEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{5}
}
...
func (*CdpAddrEntryItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{6}
}
...
func (*CdpProtHelloEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{7}
}
...
func (*CdpProtHelloEntryItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{8}
}
...
func (*CdpNeighborDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdp_neighbor_5390a43ddb369cb0, []int{9}
}
...
func init() { proto.RegisterFile("cdp_neighbor.proto", fileDescriptor_cdp_neighbor_5390a43ddb369cb0) }

var fileDescriptor_cdp_neighbor_5390a43ddb369cb0 = []byte{
