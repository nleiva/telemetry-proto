...
func (*InvXmlEntityBasicInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_inv_xml_entity_basic_info_f278d28564a2343d, []int{0}
}
...
func (*InvXmlEntityBasicInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_inv_xml_entity_basic_info_f278d28564a2343d, []int{1}
}
...
func init() {
	proto.RegisterFile("inv_xml_entity_basic_info.proto", fileDescriptor_inv_xml_entity_basic_info_f278d28564a2343d)
}

var fileDescriptor_inv_xml_entity_basic_info_f278d28564a2343d = []byte{
