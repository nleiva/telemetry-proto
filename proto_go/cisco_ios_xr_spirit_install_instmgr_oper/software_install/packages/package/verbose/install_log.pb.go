...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_9e429e627ed368d9, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_9e429e627ed368d9, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_9e429e627ed368d9) }

var fileDescriptor_install_log_9e429e627ed368d9 = []byte{
