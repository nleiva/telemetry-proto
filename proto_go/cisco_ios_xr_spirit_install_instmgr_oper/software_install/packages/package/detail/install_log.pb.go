...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_38f084252ce0cc4b, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_38f084252ce0cc4b, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_38f084252ce0cc4b) }

var fileDescriptor_install_log_38f084252ce0cc4b = []byte{
