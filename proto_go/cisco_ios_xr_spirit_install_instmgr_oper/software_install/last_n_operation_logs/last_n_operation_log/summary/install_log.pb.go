...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_5ffb47f213776daa, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_5ffb47f213776daa, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_5ffb47f213776daa) }

var fileDescriptor_install_log_5ffb47f213776daa = []byte{
