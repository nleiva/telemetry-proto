...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_edbeec520c194cd2, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_edbeec520c194cd2, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_edbeec520c194cd2) }

var fileDescriptor_install_log_edbeec520c194cd2 = []byte{
