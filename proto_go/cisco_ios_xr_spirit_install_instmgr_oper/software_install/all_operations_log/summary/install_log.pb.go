...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_6130b56acf2637ab, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_6130b56acf2637ab, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_6130b56acf2637ab) }

var fileDescriptor_install_log_6130b56acf2637ab = []byte{
