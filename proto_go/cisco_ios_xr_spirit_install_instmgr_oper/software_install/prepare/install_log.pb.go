...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_5be4c3a9b2eacc19, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_5be4c3a9b2eacc19, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_5be4c3a9b2eacc19) }

var fileDescriptor_install_log_5be4c3a9b2eacc19 = []byte{
