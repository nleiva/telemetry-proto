...
func (*IsdInvInfoContainer_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_isd_inv_info_container_0f9430b742f0faa5, []int{0}
}
...
func (dst *IsdInvInfoContainer_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IsdInvInfoContainer_KEYS.Merge(dst, src)
}
...
func (*IsdInvInfoContainer) Descriptor() ([]byte, []int) {
	return fileDescriptor_isd_inv_info_container_0f9430b742f0faa5, []int{1}
}
...
func (dst *IsdInvInfoContainer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IsdInvInfoContainer.Merge(dst, src)
}
...
func (*IsdInvInfoSt) Descriptor() ([]byte, []int) {
	return fileDescriptor_isd_inv_info_container_0f9430b742f0faa5, []int{2}
}
...
func (dst *IsdInvInfoSt) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IsdInvInfoSt.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("isd_inv_info_container.proto", fileDescriptor_isd_inv_info_container_0f9430b742f0faa5)
}

var fileDescriptor_isd_inv_info_container_0f9430b742f0faa5 = []byte{
