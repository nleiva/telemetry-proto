...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_1a91440061995eef, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_1a91440061995eef, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_1a91440061995eef) }

var fileDescriptor_install_log_1a91440061995eef = []byte{
