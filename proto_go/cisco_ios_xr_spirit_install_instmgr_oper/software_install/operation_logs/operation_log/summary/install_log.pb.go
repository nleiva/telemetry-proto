...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_f68396ba575837a4, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_f68396ba575837a4, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_f68396ba575837a4) }

var fileDescriptor_install_log_f68396ba575837a4 = []byte{
