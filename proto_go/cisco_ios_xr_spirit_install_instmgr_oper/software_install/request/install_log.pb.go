...
func (*InstallLog_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_15cc67c9b85a81ed, []int{0}
}
...
func (*InstallLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_install_log_15cc67c9b85a81ed, []int{1}
}
...
func init() { proto.RegisterFile("install_log.proto", fileDescriptor_install_log_15cc67c9b85a81ed) }

var fileDescriptor_install_log_15cc67c9b85a81ed = []byte{
