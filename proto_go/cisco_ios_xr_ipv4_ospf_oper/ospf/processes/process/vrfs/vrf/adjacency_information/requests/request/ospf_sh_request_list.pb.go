...
func (*OspfShRequestList_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_request_list_3fcea31ba9ca5cd1, []int{0}
}
...
func (*OspfShRequestList) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_request_list_3fcea31ba9ca5cd1, []int{1}
}
...
func (*OspfShLsaSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_request_list_3fcea31ba9ca5cd1, []int{2}
}
...
func init() {
	proto.RegisterFile("ospf_sh_request_list.proto", fileDescriptor_ospf_sh_request_list_3fcea31ba9ca5cd1)
}

var fileDescriptor_ospf_sh_request_list_3fcea31ba9ca5cd1 = []byte{
