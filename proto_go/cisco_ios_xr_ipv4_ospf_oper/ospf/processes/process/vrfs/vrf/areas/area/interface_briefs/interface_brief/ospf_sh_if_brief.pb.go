...
func (*OspfShIfBrief_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_if_brief_8716222e1988e77d, []int{0}
}
...
func (*OspfShIfBrief) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_if_brief_8716222e1988e77d, []int{1}
}
...
func (*OspfShInterfaceMadj) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_if_brief_8716222e1988e77d, []int{2}
}
...
func init() {
	proto.RegisterFile("ospf_sh_if_brief.proto", fileDescriptor_ospf_sh_if_brief_8716222e1988e77d)
}

var fileDescriptor_ospf_sh_if_brief_8716222e1988e77d = []byte{
