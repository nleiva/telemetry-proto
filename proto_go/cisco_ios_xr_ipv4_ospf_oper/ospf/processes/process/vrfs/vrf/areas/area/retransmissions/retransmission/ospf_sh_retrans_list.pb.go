...
func (*OspfShRetransList_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_retrans_list_8854cf2800c22aed, []int{0}
}
...
func (*OspfShRetransList) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_retrans_list_8854cf2800c22aed, []int{1}
}
...
func (*OspfShLsaSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_retrans_list_8854cf2800c22aed, []int{2}
}
...
func init() {
	proto.RegisterFile("ospf_sh_retrans_list.proto", fileDescriptor_ospf_sh_retrans_list_8854cf2800c22aed)
}

var fileDescriptor_ospf_sh_retrans_list_8854cf2800c22aed = []byte{
