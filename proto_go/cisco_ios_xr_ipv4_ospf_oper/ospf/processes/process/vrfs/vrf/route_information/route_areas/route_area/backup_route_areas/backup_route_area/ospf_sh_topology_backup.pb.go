...
func (*OspfShTopologyBackup_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056, []int{0}
}
...
func (*OspfShTopologyBackup) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056, []int{1}
}
...
func (*OspfShTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056, []int{2}
}
...
func (*OspfShRepEl) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056, []int{3}
}
...
func (*OspfShBackupPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056, []int{4}
}
...
func (*OspfShTopPathBackup) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056, []int{5}
}
...
func (*OspfShTopCommon) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056, []int{6}
}
...
func init() {
	proto.RegisterFile("ospf_sh_topology_backup.proto", fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056)
}

var fileDescriptor_ospf_sh_topology_backup_3b05c704ea403056 = []byte{
