...
func (*OspfShTopology_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_cee7ec498ef76022, []int{0}
}
...
func (*OspfShTopology) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_cee7ec498ef76022, []int{1}
}
...
func (*OspfShTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_cee7ec498ef76022, []int{2}
}
...
func (*OspfShTopCommon) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_cee7ec498ef76022, []int{3}
}
...
func (*OspfShTopPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_cee7ec498ef76022, []int{4}
}
...
func init() {
	proto.RegisterFile("ospf_sh_topology.proto", fileDescriptor_ospf_sh_topology_cee7ec498ef76022)
}

var fileDescriptor_ospf_sh_topology_cee7ec498ef76022 = []byte{
