...
func (*OspfShDbAreaSum_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_db_area_sum_3a5a5d9414a653d6, []int{0}
}
...
func (*OspfShDbAreaSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_db_area_sum_3a5a5d9414a653d6, []int{1}
}
...
func (*OspfShDbSumCntr) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_db_area_sum_3a5a5d9414a653d6, []int{2}
}
...
func init() {
	proto.RegisterFile("ospf_sh_db_area_sum.proto", fileDescriptor_ospf_sh_db_area_sum_3a5a5d9414a653d6)
}

var fileDescriptor_ospf_sh_db_area_sum_3a5a5d9414a653d6 = []byte{
