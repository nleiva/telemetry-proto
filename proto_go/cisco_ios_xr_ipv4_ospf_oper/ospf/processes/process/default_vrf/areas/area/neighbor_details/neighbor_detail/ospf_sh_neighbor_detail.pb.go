...
func (*OspfShNeighborDetail_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_detail_69eb05ba7755746b, []int{0}
}
...
func (*OspfShNeighborDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_detail_69eb05ba7755746b, []int{1}
}
...
func (*OspfShNeighborRetrans) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_detail_69eb05ba7755746b, []int{2}
}
...
func (*OspfShNeighborBfd) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_detail_69eb05ba7755746b, []int{3}
}
...
func (*OspfShNeighbor) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_detail_69eb05ba7755746b, []int{4}
}
...
func init() {
	proto.RegisterFile("ospf_sh_neighbor_detail.proto", fileDescriptor_ospf_sh_neighbor_detail_69eb05ba7755746b)
}

var fileDescriptor_ospf_sh_neighbor_detail_69eb05ba7755746b = []byte{
