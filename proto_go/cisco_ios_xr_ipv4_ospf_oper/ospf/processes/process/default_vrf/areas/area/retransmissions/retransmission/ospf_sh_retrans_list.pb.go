...
func (*OspfShRetransList_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_retrans_list_2ee6d099066a7a16, []int{0}
}
...
func (*OspfShRetransList) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_retrans_list_2ee6d099066a7a16, []int{1}
}
...
func (*OspfShLsaSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_retrans_list_2ee6d099066a7a16, []int{2}
}
...
func init() {
	proto.RegisterFile("ospf_sh_retrans_list.proto", fileDescriptor_ospf_sh_retrans_list_2ee6d099066a7a16)
}

var fileDescriptor_ospf_sh_retrans_list_2ee6d099066a7a16 = []byte{
