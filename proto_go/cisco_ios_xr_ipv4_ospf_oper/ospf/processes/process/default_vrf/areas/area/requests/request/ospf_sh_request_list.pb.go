...
func (*OspfShRequestList_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_request_list_b7eb1aacf7a2eb7b, []int{0}
}
...
func (*OspfShRequestList) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_request_list_b7eb1aacf7a2eb7b, []int{1}
}
...
func (*OspfShLsaSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_request_list_b7eb1aacf7a2eb7b, []int{2}
}
...
func init() {
	proto.RegisterFile("ospf_sh_request_list.proto", fileDescriptor_ospf_sh_request_list_b7eb1aacf7a2eb7b)
}

var fileDescriptor_ospf_sh_request_list_b7eb1aacf7a2eb7b = []byte{
