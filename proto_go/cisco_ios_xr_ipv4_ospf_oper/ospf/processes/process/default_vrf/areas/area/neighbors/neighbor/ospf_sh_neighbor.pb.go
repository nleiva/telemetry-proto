...
func (*OspfShNeighbor_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_6b7c31d00aeb37db, []int{0}
}
...
func (*OspfShNeighbor) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_6b7c31d00aeb37db, []int{1}
}
...
func (*OspfShNeighborBfd) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_6b7c31d00aeb37db, []int{2}
}
...
func init() {
	proto.RegisterFile("ospf_sh_neighbor.proto", fileDescriptor_ospf_sh_neighbor_6b7c31d00aeb37db)
}

var fileDescriptor_ospf_sh_neighbor_6b7c31d00aeb37db = []byte{
