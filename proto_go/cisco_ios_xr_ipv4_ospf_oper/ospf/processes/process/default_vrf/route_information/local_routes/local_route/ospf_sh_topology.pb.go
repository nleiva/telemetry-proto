...
func (*OspfShTopology_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_e1b70a476e04184d, []int{0}
}
...
func (*OspfShTopology) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_e1b70a476e04184d, []int{1}
}
...
func (*OspfShTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_e1b70a476e04184d, []int{2}
}
...
func (*OspfShTopCommon) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_e1b70a476e04184d, []int{3}
}
...
func (*OspfShTopPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_topology_e1b70a476e04184d, []int{4}
}
...
func init() {
	proto.RegisterFile("ospf_sh_topology.proto", fileDescriptor_ospf_sh_topology_e1b70a476e04184d)
}

var fileDescriptor_ospf_sh_topology_e1b70a476e04184d = []byte{
