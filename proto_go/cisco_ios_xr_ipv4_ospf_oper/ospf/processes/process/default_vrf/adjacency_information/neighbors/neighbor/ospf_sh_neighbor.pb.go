...
func (*OspfShNeighbor_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_be312bf75ae1ec1b, []int{0}
}
...
func (*OspfShNeighbor) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_be312bf75ae1ec1b, []int{1}
}
...
func (*OspfShNeighborBfd) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospf_sh_neighbor_be312bf75ae1ec1b, []int{2}
}
...
func init() {
	proto.RegisterFile("ospf_sh_neighbor.proto", fileDescriptor_ospf_sh_neighbor_be312bf75ae1ec1b)
}

var fileDescriptor_ospf_sh_neighbor_be312bf75ae1ec1b = []byte{
