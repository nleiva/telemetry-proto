...
func (*LldpNeighbor_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{0}
}
...
func (m *LldpNeighbor_KEYS) XXX_DiscardUnknown() {
	xxx_messageInfo_LldpNeighbor_KEYS.DiscardUnknown(m)
}

var xxx_messageInfo_LldpNeighbor_KEYS proto.InternalMessageInfo
...
func (*LldpNeighbor) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{1}
}
...
func (*LldpNeighborItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{2}
}
...
func (*In6AddrTd) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{3}
}
...
func (*LldpL3Addr) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{4}
}
...
func (*LldpAddrEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{5}
}
...
func (*LldpAddrEntryItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{6}
}
...
func (*LldpUnknownTlvEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{7}
}
...
func (m *LldpUnknownTlvEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_LldpUnknownTlvEntry.DiscardUnknown(m)
}

var xxx_messageInfo_LldpUnknownTlvEntry proto.InternalMessageInfo
...
func (*LldpUnknownTlvEntryItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{8}
}
...
func (*LldpOrgDefTlvEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{9}
}
...
func (m *LldpOrgDefTlvEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_LldpOrgDefTlvEntry.DiscardUnknown(m)
}

var xxx_messageInfo_LldpOrgDefTlvEntry proto.InternalMessageInfo
...
func (*LldpOrgDefTlvEntryItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{10}
}
...
func (*LldpNeighborDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{11}
}
...
func (*LldpNeighborMib) Descriptor() ([]byte, []int) {
	return fileDescriptor_lldp_neighbor_cd446d45d51d1561, []int{12}
}
...
func init() { proto.RegisterFile("lldp_neighbor.proto", fileDescriptor_lldp_neighbor_cd446d45d51d1561) }

var fileDescriptor_lldp_neighbor_cd446d45d51d1561 = []byte{
