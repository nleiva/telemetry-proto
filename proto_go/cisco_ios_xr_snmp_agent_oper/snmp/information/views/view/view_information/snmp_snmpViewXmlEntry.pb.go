...
func (*SnmpSnmpViewXmlEntry_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_snmp_snmpViewXmlEntry_a20670522f86a421, []int{0}
}
...
func (dst *SnmpSnmpViewXmlEntry_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SnmpSnmpViewXmlEntry_KEYS.Merge(dst, src)
}
...
func (*SnmpSnmpViewXmlEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_snmp_snmpViewXmlEntry_a20670522f86a421, []int{1}
}
...
func (dst *SnmpSnmpViewXmlEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SnmpSnmpViewXmlEntry.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("snmp_snmpViewXmlEntry.proto", fileDescriptor_snmp_snmpViewXmlEntry_a20670522f86a421)
}

var fileDescriptor_snmp_snmpViewXmlEntry_a20670522f86a421 = []byte{
