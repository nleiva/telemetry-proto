...
func (*SnmpVacmAccessEntry_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_snmp_vacmAccessEntry_d1ce8326dbcd30eb, []int{0}
}
...
func (dst *SnmpVacmAccessEntry_KEYS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SnmpVacmAccessEntry_KEYS.Merge(dst, src)
}
...
func (*SnmpVacmAccessEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_snmp_vacmAccessEntry_d1ce8326dbcd30eb, []int{1}
}
...
func (dst *SnmpVacmAccessEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SnmpVacmAccessEntry.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("snmp_vacmAccessEntry.proto", fileDescriptor_snmp_vacmAccessEntry_d1ce8326dbcd30eb)
}

var fileDescriptor_snmp_vacmAccessEntry_d1ce8326dbcd30eb = []byte{
