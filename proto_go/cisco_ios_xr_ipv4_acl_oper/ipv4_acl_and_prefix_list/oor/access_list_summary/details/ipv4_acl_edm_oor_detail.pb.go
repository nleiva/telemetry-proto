...
func (*Ipv4AclEdmOorDetail_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_acl_edm_oor_detail_98d38c0bc291b765, []int{0}
}
...
func (*Ipv4AclEdmOorDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_acl_edm_oor_detail_98d38c0bc291b765, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv4_acl_edm_oor_detail.proto", fileDescriptor_ipv4_acl_edm_oor_detail_98d38c0bc291b765)
}

var fileDescriptor_ipv4_acl_edm_oor_detail_98d38c0bc291b765 = []byte{
