...
func (*Ipv4AclEdmOorDetail_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_acl_edm_oor_detail_49bef2e86376b702, []int{0}
}
...
func (*Ipv4AclEdmOorDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_acl_edm_oor_detail_49bef2e86376b702, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv4_acl_edm_oor_detail.proto", fileDescriptor_ipv4_acl_edm_oor_detail_49bef2e86376b702)
}

var fileDescriptor_ipv4_acl_edm_oor_detail_49bef2e86376b702 = []byte{
