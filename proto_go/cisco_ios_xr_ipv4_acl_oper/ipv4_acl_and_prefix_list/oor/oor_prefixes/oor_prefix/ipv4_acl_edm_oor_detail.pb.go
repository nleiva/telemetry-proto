...
func (*Ipv4AclEdmOorDetail_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_acl_edm_oor_detail_e0c3b63fdfe0dddb, []int{0}
}
...
func (*Ipv4AclEdmOorDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_acl_edm_oor_detail_e0c3b63fdfe0dddb, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv4_acl_edm_oor_detail.proto", fileDescriptor_ipv4_acl_edm_oor_detail_e0c3b63fdfe0dddb)
}

var fileDescriptor_ipv4_acl_edm_oor_detail_e0c3b63fdfe0dddb = []byte{
