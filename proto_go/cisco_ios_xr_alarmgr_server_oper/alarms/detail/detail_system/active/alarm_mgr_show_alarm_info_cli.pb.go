...
func (*AlarmMgrShowAlarmInfoCli_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_alarm_mgr_show_alarm_info_cli_3f55404fe9a6b395, []int{0}
}
...
func (*AlarmMgrShowAlarmInfoCli) Descriptor() ([]byte, []int) {
	return fileDescriptor_alarm_mgr_show_alarm_info_cli_3f55404fe9a6b395, []int{1}
}
...
func (*AlarmOtn) Descriptor() ([]byte, []int) {
	return fileDescriptor_alarm_mgr_show_alarm_info_cli_3f55404fe9a6b395, []int{2}
}
...
func (*AlarmTca) Descriptor() ([]byte, []int) {
	return fileDescriptor_alarm_mgr_show_alarm_info_cli_3f55404fe9a6b395, []int{3}
}
...
func (*AlarmMgrShowAlarmData) Descriptor() ([]byte, []int) {
	return fileDescriptor_alarm_mgr_show_alarm_info_cli_3f55404fe9a6b395, []int{4}
}
...
func init() {
	proto.RegisterFile("alarm_mgr_show_alarm_info_cli.proto", fileDescriptor_alarm_mgr_show_alarm_info_cli_3f55404fe9a6b395)
}

var fileDescriptor_alarm_mgr_show_alarm_info_cli_3f55404fe9a6b395 = []byte{
