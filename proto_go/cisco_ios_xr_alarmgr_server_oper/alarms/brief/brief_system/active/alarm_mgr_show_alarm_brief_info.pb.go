...
func (*AlarmMgrShowAlarmBriefInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_alarm_mgr_show_alarm_brief_info_9905f7cdd92e5a31, []int{0}
}
...
func (*AlarmMgrShowAlarmBriefInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_alarm_mgr_show_alarm_brief_info_9905f7cdd92e5a31, []int{1}
}
...
func (*AlarmMgrShowAlarmBriefData) Descriptor() ([]byte, []int) {
	return fileDescriptor_alarm_mgr_show_alarm_brief_info_9905f7cdd92e5a31, []int{2}
}
...
func init() {
	proto.RegisterFile("alarm_mgr_show_alarm_brief_info.proto", fileDescriptor_alarm_mgr_show_alarm_brief_info_9905f7cdd92e5a31)
}

var fileDescriptor_alarm_mgr_show_alarm_brief_info_9905f7cdd92e5a31 = []byte{
