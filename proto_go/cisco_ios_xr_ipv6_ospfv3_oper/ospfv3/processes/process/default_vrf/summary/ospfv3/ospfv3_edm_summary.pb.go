...
func (*Ospfv3EdmSummary_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{0}
}
...
func (*Ospfv3EdmSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{1}
}
...
func (*Ospfv3EdmTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{2}
}
...
func (*Ospfv3EdmRedist) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{3}
}
...
func (*Ospfv3ShDomainIdEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{4}
}
...
func (*Ospfv3ShDomainId) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{5}
}
...
func (*Ospfv3ShStubRouterTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{6}
}
...
func (*Ospfv3ShStubRouter) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{7}
}
...
func (*OspfShIpfrrTb) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147, []int{8}
}
...
func init() {
	proto.RegisterFile("ospfv3_edm_summary.proto", fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147)
}

var fileDescriptor_ospfv3_edm_summary_b2d0f5d00cdef147 = []byte{
