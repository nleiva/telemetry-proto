...
func (*Ospfv3EdmRouteSum_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_route_sum_c4b8346930f5906f, []int{0}
}
...
func (*Ospfv3EdmRouteSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_route_sum_c4b8346930f5906f, []int{1}
}
...
func init() {
	proto.RegisterFile("ospfv3_edm_route_sum.proto", fileDescriptor_ospfv3_edm_route_sum_c4b8346930f5906f)
}

var fileDescriptor_ospfv3_edm_route_sum_c4b8346930f5906f = []byte{
