...
func (*Ospfv3EdmRequest_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_request_0ed0d4d3b289e95f, []int{0}
}
...
func (*Ospfv3EdmRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_request_0ed0d4d3b289e95f, []int{1}
}
...
func (*Ospfv3EdmLsaSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_request_0ed0d4d3b289e95f, []int{2}
}
...
func init() {
	proto.RegisterFile("ospfv3_edm_request.proto", fileDescriptor_ospfv3_edm_request_0ed0d4d3b289e95f)
}

var fileDescriptor_ospfv3_edm_request_0ed0d4d3b289e95f = []byte{
