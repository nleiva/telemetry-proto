...
func (*Ospfv3ShBadChecksum_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_sh_bad_checksum_295b9575130b75ed, []int{0}
}
...
func (*Ospfv3ShBadChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_sh_bad_checksum_295b9575130b75ed, []int{1}
}
...
func (*Ospfv3EdmTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_sh_bad_checksum_295b9575130b75ed, []int{2}
}
...
func init() {
	proto.RegisterFile("ospfv3_sh_bad_checksum.proto", fileDescriptor_ospfv3_sh_bad_checksum_295b9575130b75ed)
}

var fileDescriptor_ospfv3_sh_bad_checksum_295b9575130b75ed = []byte{
