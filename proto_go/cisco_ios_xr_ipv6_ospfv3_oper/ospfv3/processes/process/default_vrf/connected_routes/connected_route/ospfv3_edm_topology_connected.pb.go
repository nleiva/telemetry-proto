...
func (*Ospfv3EdmTopologyConnected_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_topology_connected_336939d2ffa9e391, []int{0}
}
...
func (*Ospfv3EdmTopologyConnected) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_topology_connected_336939d2ffa9e391, []int{1}
}
...
func (*Ospfv3ShBackupPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_topology_connected_336939d2ffa9e391, []int{2}
}
...
func (*Ospfv3EdmTopPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_topology_connected_336939d2ffa9e391, []int{3}
}
...
func (*Ospfv3EdmTopology) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_topology_connected_336939d2ffa9e391, []int{4}
}
...
func init() {
	proto.RegisterFile("ospfv3_edm_topology_connected.proto", fileDescriptor_ospfv3_edm_topology_connected_336939d2ffa9e391)
}

var fileDescriptor_ospfv3_edm_topology_connected_336939d2ffa9e391 = []byte{
