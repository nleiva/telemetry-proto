...
func (*Ospfv3EdmRequest_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_request_166618d6cd53c77b, []int{0}
}
...
func (*Ospfv3EdmRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_request_166618d6cd53c77b, []int{1}
}
...
func (*Ospfv3EdmLsaSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_request_166618d6cd53c77b, []int{2}
}
...
func init() {
	proto.RegisterFile("ospfv3_edm_request.proto", fileDescriptor_ospfv3_edm_request_166618d6cd53c77b)
}

var fileDescriptor_ospfv3_edm_request_166618d6cd53c77b = []byte{
