...
func (*Ospfv3EdmRetrans_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_retrans_d7dc70324ac7a983, []int{0}
}
...
func (*Ospfv3EdmRetrans) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_retrans_d7dc70324ac7a983, []int{1}
}
...
func (*Ospfv3EdmLsaSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_retrans_d7dc70324ac7a983, []int{2}
}
...
func init() {
	proto.RegisterFile("ospfv3_edm_retrans.proto", fileDescriptor_ospfv3_edm_retrans_d7dc70324ac7a983)
}

var fileDescriptor_ospfv3_edm_retrans_d7dc70324ac7a983 = []byte{
