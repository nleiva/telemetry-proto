...
func (*Ospfv3EdmNeighbor_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_neighbor_15c44dfe298bd5e5, []int{0}
}
...
func (*Ospfv3EdmNeighbor) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_neighbor_15c44dfe298bd5e5, []int{1}
}
...
func (*Ospfv3EdmNeighborRetrans) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_neighbor_15c44dfe298bd5e5, []int{2}
}
...
func (*Ospfv3EdmNeighborBfd) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_neighbor_15c44dfe298bd5e5, []int{3}
}
...
func (*Ospfv3EdmNeighborDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_ospfv3_edm_neighbor_15c44dfe298bd5e5, []int{4}
}
...
func init() {
	proto.RegisterFile("ospfv3_edm_neighbor.proto", fileDescriptor_ospfv3_edm_neighbor_15c44dfe298bd5e5)
}

var fileDescriptor_ospfv3_edm_neighbor_15c44dfe298bd5e5 = []byte{
