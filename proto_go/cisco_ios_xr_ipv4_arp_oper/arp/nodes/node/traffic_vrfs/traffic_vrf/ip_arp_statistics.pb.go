...
func (*IpArpStatistics_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ip_arp_statistics_3f990cc629047a42, []int{0}
}
...
func (*IpArpStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_ip_arp_statistics_3f990cc629047a42, []int{1}
}
...
func init() {
	proto.RegisterFile("ip_arp_statistics.proto", fileDescriptor_ip_arp_statistics_3f990cc629047a42)
}

var fileDescriptor_ip_arp_statistics_3f990cc629047a42 = []byte{
