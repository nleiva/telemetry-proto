...
func (*IpArpStatistics_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ip_arp_statistics_19d3c320d42f95d3, []int{0}
}
...
func (*IpArpStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_ip_arp_statistics_19d3c320d42f95d3, []int{1}
}
...
func init() {
	proto.RegisterFile("ip_arp_statistics.proto", fileDescriptor_ip_arp_statistics_19d3c320d42f95d3)
}

var fileDescriptor_ip_arp_statistics_19d3c320d42f95d3 = []byte{
