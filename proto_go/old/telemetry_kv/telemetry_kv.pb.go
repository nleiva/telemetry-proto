...
func (*TelemetryOLD) Descriptor() ([]byte, []int) {
	return fileDescriptor_b241eda48656d033, []int{0}
}
...
func (m *TelemetryOLD) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TelemetryOLD.Merge(m, src)
}
...
func (*TelemetryFieldOLD) Descriptor() ([]byte, []int) {
	return fileDescriptor_b241eda48656d033, []int{1}
}
...
func (m *TelemetryFieldOLD) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TelemetryFieldOLD.Merge(m, src)
}
...
func init() { proto.RegisterFile("telemetry_kv.proto", fileDescriptor_b241eda48656d033) }

var fileDescriptor_b241eda48656d033 = []byte{
