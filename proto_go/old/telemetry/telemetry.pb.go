...
func (m *TelemetryHeader) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TelemetryHeader.Merge(m, src)
}
...
func (m *TelemetryTable) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TelemetryTable.Merge(m, src)
}
