...
func (*MdtDialoutArgs) Descriptor() ([]byte, []int) {
	return fileDescriptor_mdt_grpc_dialout_ecf5a70fcd197c0b, []int{0}
}
...
func init() {
	proto.RegisterFile("mdt_grpc_dialout.proto", fileDescriptor_mdt_grpc_dialout_ecf5a70fcd197c0b)
}

var fileDescriptor_mdt_grpc_dialout_ecf5a70fcd197c0b = []byte{
