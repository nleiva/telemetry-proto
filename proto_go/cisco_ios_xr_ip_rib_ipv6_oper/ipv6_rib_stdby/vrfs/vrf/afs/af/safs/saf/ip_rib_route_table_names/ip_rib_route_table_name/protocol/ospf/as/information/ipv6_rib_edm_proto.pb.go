...
func (*Ipv6RibEdmProto_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_proto_451cd56128826901, []int{0}
}
...
func (*Ipv6RibEdmProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_proto_451cd56128826901, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv6_rib_edm_proto.proto", fileDescriptor_ipv6_rib_edm_proto_451cd56128826901)
}

var fileDescriptor_ipv6_rib_edm_proto_451cd56128826901 = []byte{
