...
func (*Ipv6RibEdmProto_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_proto_965405e75fac8d05, []int{0}
}
...
func (*Ipv6RibEdmProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_proto_965405e75fac8d05, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv6_rib_edm_proto.proto", fileDescriptor_ipv6_rib_edm_proto_965405e75fac8d05)
}

var fileDescriptor_ipv6_rib_edm_proto_965405e75fac8d05 = []byte{
