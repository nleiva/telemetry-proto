...
func (*RibEdmProtoRouteSummDetail_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_rib_edm_proto_route_summ_detail_59efb18998ed10ac, []int{0}
}
...
func (*RibEdmProtoRouteSummDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_rib_edm_proto_route_summ_detail_59efb18998ed10ac, []int{1}
}
...
func (*RibEdmRouteCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_rib_edm_proto_route_summ_detail_59efb18998ed10ac, []int{2}
}
...
func init() {
	proto.RegisterFile("rib_edm_proto_route_summ_detail.proto", fileDescriptor_rib_edm_proto_route_summ_detail_59efb18998ed10ac)
}

var fileDescriptor_rib_edm_proto_route_summ_detail_59efb18998ed10ac = []byte{
