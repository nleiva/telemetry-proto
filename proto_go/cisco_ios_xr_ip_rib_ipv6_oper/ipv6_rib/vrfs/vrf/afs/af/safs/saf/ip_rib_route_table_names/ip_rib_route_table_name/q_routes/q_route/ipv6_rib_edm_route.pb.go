...
func (*Ipv6RibEdmRoute_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_route_e329c73bc2dbd845, []int{0}
}
...
func (*Ipv6RibEdmRoute) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_route_e329c73bc2dbd845, []int{1}
}
...
func (*Ipv6RibEdmAddr) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_route_e329c73bc2dbd845, []int{2}
}
...
func (*Ipv6RibEdmPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_route_e329c73bc2dbd845, []int{3}
}
...
func (*Ipv6RibEdmPathItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_route_e329c73bc2dbd845, []int{4}
}
...
func (*RibEdmLocalLabel) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv6_rib_edm_route_e329c73bc2dbd845, []int{5}
}
...
func init() {
	proto.RegisterFile("ipv6_rib_edm_route.proto", fileDescriptor_ipv6_rib_edm_route_e329c73bc2dbd845)
}

var fileDescriptor_ipv6_rib_edm_route_e329c73bc2dbd845 = []byte{
