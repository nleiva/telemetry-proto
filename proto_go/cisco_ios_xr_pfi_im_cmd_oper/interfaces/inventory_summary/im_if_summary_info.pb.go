...
func (*ImIfSummaryInfo_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_im_if_summary_info_ff1c0a12b66b9bdf, []int{0}
}
...
func (*ImIfSummaryInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_im_if_summary_info_ff1c0a12b66b9bdf, []int{1}
}
...
func (*ImIfGroupCountsSt) Descriptor() ([]byte, []int) {
	return fileDescriptor_im_if_summary_info_ff1c0a12b66b9bdf, []int{2}
}
...
func (*ImIfTypeSummarySt) Descriptor() ([]byte, []int) {
	return fileDescriptor_im_if_summary_info_ff1c0a12b66b9bdf, []int{3}
}
...
func init() {
	proto.RegisterFile("im_if_summary_info.proto", fileDescriptor_im_if_summary_info_ff1c0a12b66b9bdf)
}

var fileDescriptor_im_if_summary_info_ff1c0a12b66b9bdf = []byte{
