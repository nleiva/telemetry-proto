...
func (*Ipv4RibEdmRoute_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_route_c9447decbd87a313, []int{0}
}
...
func (*Ipv4RibEdmRoute) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_route_c9447decbd87a313, []int{1}
}
...
func (*Ipv4RibEdmPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_route_c9447decbd87a313, []int{2}
}
...
func (*Ipv4RibEdmPathItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_route_c9447decbd87a313, []int{3}
}
...
func (*RibEdmLocalLabel) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_route_c9447decbd87a313, []int{4}
}
...
func init() {
	proto.RegisterFile("ipv4_rib_edm_route.proto", fileDescriptor_ipv4_rib_edm_route_c9447decbd87a313)
}

var fileDescriptor_ipv4_rib_edm_route_c9447decbd87a313 = []byte{
