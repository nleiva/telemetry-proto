...
func (*Ipv4RibEdmProto_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_proto_004a5126422d3aad, []int{0}
}
...
func (*Ipv4RibEdmProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_proto_004a5126422d3aad, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv4_rib_edm_proto.proto", fileDescriptor_ipv4_rib_edm_proto_004a5126422d3aad)
}

var fileDescriptor_ipv4_rib_edm_proto_004a5126422d3aad = []byte{
