...
func (*Ipv4RibEdmProto_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_proto_732df066f25f73d3, []int{0}
}
...
func (*Ipv4RibEdmProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_proto_732df066f25f73d3, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv4_rib_edm_proto.proto", fileDescriptor_ipv4_rib_edm_proto_732df066f25f73d3)
}

var fileDescriptor_ipv4_rib_edm_proto_732df066f25f73d3 = []byte{
