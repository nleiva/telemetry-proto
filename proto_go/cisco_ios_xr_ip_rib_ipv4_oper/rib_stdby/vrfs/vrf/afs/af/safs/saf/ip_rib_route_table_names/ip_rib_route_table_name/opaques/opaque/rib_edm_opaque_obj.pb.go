...
func (*RibEdmOpaqueObj_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_rib_edm_opaque_obj_b6b7bea308a493bb, []int{0}
}
...
func (*RibEdmOpaqueObj) Descriptor() ([]byte, []int) {
	return fileDescriptor_rib_edm_opaque_obj_b6b7bea308a493bb, []int{1}
}
...
func init() {
	proto.RegisterFile("rib_edm_opaque_obj.proto", fileDescriptor_rib_edm_opaque_obj_b6b7bea308a493bb)
}

var fileDescriptor_rib_edm_opaque_obj_b6b7bea308a493bb = []byte{
