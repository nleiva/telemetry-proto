...
func (*Ipv4RibEdmProto_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_proto_7a10498dacadfd9e, []int{0}
}
...
func (*Ipv4RibEdmProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_proto_7a10498dacadfd9e, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv4_rib_edm_proto.proto", fileDescriptor_ipv4_rib_edm_proto_7a10498dacadfd9e)
}

var fileDescriptor_ipv4_rib_edm_proto_7a10498dacadfd9e = []byte{
