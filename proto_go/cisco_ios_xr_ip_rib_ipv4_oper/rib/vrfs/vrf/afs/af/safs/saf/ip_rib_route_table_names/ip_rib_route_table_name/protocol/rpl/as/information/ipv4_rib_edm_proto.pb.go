...
func (*Ipv4RibEdmProto_KEYS) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_proto_28897a8a0745ee57, []int{0}
}
...
func (*Ipv4RibEdmProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_ipv4_rib_edm_proto_28897a8a0745ee57, []int{1}
}
...
func init() {
	proto.RegisterFile("ipv4_rib_edm_proto.proto", fileDescriptor_ipv4_rib_edm_proto_28897a8a0745ee57)
}

var fileDescriptor_ipv4_rib_edm_proto_28897a8a0745ee57 = []byte{
